...
def main():
    ...
    ChrTalk(
        0x109,
        "#10102FYes…That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#11609Fフフ、外に立っているその子#6R噵　噵　噵#のことも、\x01",
            "どうかよろしくたのんだわね。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "絶対に諦めたりしない……\x01",
            "だから、最後まで頑張ってちょうだい。\x02\x03",
            "#11609Fフフ、あの子#6R噵　噵　噵#にもよろしくね。\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#11712F#5P#30WえへWhat…Yes.\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "……どうもThanks for your hard work\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00104F#6P#NYeah I know.\x02\x03",
    ...
    ChrTalk(
        0x109,
        (
            "#10106F#5PYes…\x02\x03",
            "#10108F行方不明のHeiyue同様、\x01",
            "自治州に居るのか居ないのかも\x01",
            "はっきりしませんし……\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        "#00204F#5PWell then excuse me\x02",
    )
    ...
    ChrTalk(
        0xB,
        (
            "#11604F#11P舞台にしてもそうBut…\x01",
            "どこかに必ず“答え”はあるの。\x02\x03",
            "#11600Fどんなに苦しくても、絶望的でも、\x01",
            "一筋の光明は絶対#4R噵　噵#にあるわ。\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00000F#6Pああ、Yeah we should\x02",
    )
    ...
    ChrTalk(
        0xB,
        (
            "#11P#11604Fフフ、誰だか知らないけど#18R噵　噵　噵　噵　噵　噵　噵　噵　噵#\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00002F……That's fine, thank you\x01",
            "大事にさせてもらいます。\x02",
        )
    )
