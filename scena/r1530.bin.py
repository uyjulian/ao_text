...
def main():
    ...
    ChrTalk(
        0x101,
        "#00000FOH thank you very much\x02",
    )
    ...
    ChrTalk(
        0x103,
        (
            "#00203F#5P……今の所、はっきりとRight.\x02\x03",
