...
def main():
    ...
    ChrTalk(
        0x101,
        "#12P#00001FThere was a place like this\x02",
    )
    ...
    ChrTalk(
        0x9,
        (
            "#11P#04605FAh, yeah that does seem to be true\x02\x03",
            "#04609Fちなみに今日は貸し切りだから\x01",
            "遠慮なくくつろいじゃっていいよ。\x02\x03",
            "#04602FOk come in come in!\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        "#6P#10302FShe really does what she wants\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#04504F#11PHaha, that guy full of nonsense \x02\x03",
            "《鉄血》の懐刀だけあって\x01",
            "なかなか面白い小僧だ。\x02\x03",
    ...
    ChrTalk(
        0x104,
        (
            "#11P#00313F#40W#25AあAh...そうだ。\x02\x03",
            "#50W#30Aこの上もなく図星で……\x01",
            "痛いところを突かれちまった。\x02",
        )
    )
