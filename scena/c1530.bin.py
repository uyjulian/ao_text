...
def main():
    ...
    ChrTalk(
        ...
        (
            "はは、そうTrue.\x01",
            "こちらこそPleased to make your acquantiance\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        "#10100Fグラント一尉、Thanks for your hard work\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#11P#00005Fは、Right. Understood\x02",
    )
    ...
    ChrTalk(
        0xB,
        "O-oh it's just you guys SSS\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00200FWhat are you doing here?\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00203FI see. I didn't study the documents enough\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00006FI didn't stop her in time\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "You are here on a break then?\x02",
        )
    )
    ...
    ChrTalk(
        0xC,
        (
            "#02110FOh you came Lloyd and Co\x02\x03",
            "#02102Fいや〜、しっかし\x01",
    ...
    ChrTalk(
        0x105,
        (
            "#12P#10300FThat Fulitzer Prize, right?\x02\x03",
            "確か、毎年最も優秀な\x01",
            "ジャーナリストに贈られる\x01",
            "栄誉ある賞のことだっけ。\x02",
        )
    ...
    ChrTalk(
        ...
        (
            ...
            "#02103F記者ならば、誰もが\x01",
            "一度は憧れるThat Fulitzer Prize, right?\x02\x03",
            "明日の栄冠のためにも\x01",
            "日々の取材、特に今回の取材は\x01",
            "うんっと大事にしないと。\x02\x03",
            "#02110Fだからレインズ君、\x01",
    ...
    ChrTalk(
        0x102,
        "#11P#00104FWe're so happy to hear that\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#12P#00302FHaha, thanks a lot\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#02210F#5PYes, so far it's been good\x02\x03",
            "幾つかの通商協定には\x01",
            "各国の同意も得られたし……\x02\x03",
    ...
    ChrTalk(
        0x109,
        "#12P#10109FThat makes me feel better\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "様々なねじれ#6R噵　噵　噵#と悲劇を生んだ……\x02\x03",
            "クロスベルに少しでも主権が\x01",
            "認められれば、もう少し状況は\x01",
            "変わるのでしょうけど……\x02\x03",
    ...
    ChrTalk(
        0x103,
        "#00206F#11PIt makes you sigh, doesn't it\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#11P#00105FWhat would that be…\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "#00006Fま、待ってください!\x01",
            "いったい何がどうして……\x02\x03",
            "#00011FThat's too much to take!\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "Don't be naive, Bannings\x02\x03",
            "両者の思惑をうかがえる\x01",
            "またとない機会だろうが？\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "Once you finish, come report\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#02205F#5POh I'm surprised\x02\x03",
    ...
    AnonymousTalk(
        0x101,
        "#00011FA Cryptid <This means \"Unidentified Mysterious Creature\">\x02",
    )
    ...
    ChrTalk(
        0x22,
        "#11PBut t had a very strange response\x02",
    )
    ...
    ChrTalk(
        0x105,
        (
            "#10303F#12P#NBut the nothern mountain district…\x02\x03",
            "#10301FSo this time it appeard outdoors\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00303F#6P#NI see. That's true\x02",
    )
