...
def main():
    ...
    ChrTalk(
        0x101,
        "#00000FえUh…We'll count on you!\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "理解したくはありませんが、\x01",
            "そんな所だと思います。\x02\x03",
            "#00200Fともかく、魔導杖のやり取りに#18R噵　噵　噵　噵　噵　噵　噵　噵　噵#\x01",
            "関しては#8R噵　噵　噵　噵#もう慣れました。\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#6P#00100FNice to see you again\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#10100F#12Pは、Right. Understood\x02",
    )
    ...
    ChrTalk(
        0xA,
        (
            "#04100FYes, that's right\x02\x03",
            "テスタメンツが先導し、\x01",
            "旧市街の住民総出で\x01",
            "作業に当たっているが……\x02\x03",
            "いまだ襲撃の傷跡は大きく、\x01",
    ...
    Menu(
        ...
        0,
        (
            "Choice 1: Help with the reconstruction\x01",      # 0
            "いったん考える\x01",            # 1
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00000FNo prob, leave it to us\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00205F問題？　What would that be…\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            scpstr(SCPSTR_CODE_COLOR, 0x0),
            "１０個Handed over Bitter Tomato Paste\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000FNo prob, leave it to us\x02\x03",
            "#00005Fって、主だった場所は\x01",
            "ほとんど手伝い終わったAh…\x02\x03",
