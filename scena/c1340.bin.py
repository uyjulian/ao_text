...
def main():
    ...
    ChrTalk(
        0x109,
        "#12P#10109Fふふっ、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#12P#00103FYeah I know.盗まれたのは\x01",
            "ベルの大事にしている\x01",
            "ローゼンベルクドールなんだし。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00009Fはは、確かにYeah we should\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00000FYes, leave it to us\x02",
    )
