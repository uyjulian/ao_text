...
def main():
    ...
    ChrTalk(
        0x104,
        "#00301F急いだ方がよさYeah we should\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#11P#00003Fうーん、どうだったかAh…\x01",
            "（確かにどこかで聞いたことが\x01",
            "  あるような、ないようAh…）\x02\x03",
