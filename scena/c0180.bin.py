...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#01110FUh, it's suuper big\x02\x03",
            "色も青と白でキレーで、\x01",
    ...
    ChrTalk(
        0x2D,
        (
            "#5P#03205F──今のところ、特にRight.\x02\x03",
    ...
    ChrTalk(
        0x2D,
        (
            "#5P#03204FRed Constellationの動向については\x01",
    ...
    ChrTalk(
        0x102,
        (
            "#12P#00103FCommonly known as the Orchis Tower\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#10302FIt should be complete soon right?\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "普通の外国人と同じレベルでは\x01",
            "取り調べる事ができる……\x02\x03",
            "#10300FI see. So that' what you mean\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            "……仕方ない。\x01",
            "年貢の納め時のようRight.\x02\x03",
            "Fine, my affiliation is…\x02",
        )
    )
    ...
    ChrTalk(
        0x2E,
        (
            "#N#03505FThat building over there\x02\x03",
            "#03506F……なんか黒い人影が\x01",
            "屋根を飛び回ってないか？\x02",
        )
    )
