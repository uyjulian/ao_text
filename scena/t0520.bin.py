...
def main():
    ...
    ChrTalk(
        0x104,
        (
            "#00303Fだが、当然Red Constellationも\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "大規模な計画みたいBut…\x02\x03",
            "#00908F……オリビエさんたちが心配Right.\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#5P#00105FThat's right..レンちゃんは？\x02",
    )
    ...
    ChrTalk(
        0x13,
        (
            "#11P#03903FうHmm彼らの連絡を受けてな。\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "果たして歴史に選ばれるのか#18R噵　噵　噵　噵　噵　噵　噵　噵　噵#をね。\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        "#00205F#6PWhat would that be…\x02",
    )
