...
def main():
    ...
    Sepith("Sepith_1C6C", 8,   4,   4,   16,  15,  17,  4)
    Sepith("Sepith_1C74", 12,  23,  0,   16,  0,   0,   20)
    Sepith("Sepith_1C64", 8,   8,   18,  8,   2,   8,   16)
    Sepith("Sepith_1C54", 14,  14,  14,  14,  4,   9,   6)
    Sepith("Sepith_1C5C", 9,   9,   9,   9,   13,  13,  13)
    ...
    BattleInfo(
        "BattleInfo_60C", 0x0000, 105, 6, 60, 10, 1, 35, 0, "bm9020", "Sepith_1C6C", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_6D4", 0x0000, 105, 6, 60, 10, 1, 35, 0, "bm9020", "Sepith_1C74", 100, 0, 0, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_570", 0x0000, 105, 6, 60, 10, 1, 40, 0, "bm9020", "Sepith_1C64", 40, 35, 25, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_438", 0x0000, 105, 6, 60, 10, 1, 35, 0, "bm9020", "Sepith_1C54", 40, 35, 25, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_4D4", 0x0000, 105, 6, 60, 10, 1, 35, 0, "bm9020", "Sepith_1C5C", 40, 35, 25, 0,
        (
    ...
    ScpFunction((
        ...
        "Function_4_154E",         # 04, 4
        "Function_5_1646",         # 05, 5
        "Function_6_1797",         # 06, 6
        "Function_7_19B2",         # 07, 7
        "Function_8_1ADB",         # 08, 8
    ))
    ...
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x207, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1436")
    ...
    def Function_4_154E(): pass

    label("Function_4_154E")

    OP_F4(0x1)
    SetMapFlags(0x8000000)
    FadeToDark(300, 0, 100)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x201, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1616")
    Sound(14, 0, 100, 0)
    OP_74(0x1, 0x1E)
    ...
    OP_F4(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x201, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1742")
    Sound(14, 0, 100, 0)
    OP_74(0x2, 0x1E)
    OP_71(0x2, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FA, 1)"), scpexpr(EXPR_END)), "loc_16CB")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_6_1797(): pass

    label("Function_6_1797")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x201, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1968")
    Sound(14, 0, 100, 0)
    OP_74(0x3, 0x1E)
    OP_71(0x3, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x219, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_189A")
    ...
    QueueWorkItem(0x9, 2, lambda_180E)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x408, 1)"), scpexpr(EXPR_END)), "loc_18F3")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    def Function_7_19B2(): pass

    label("Function_7_19B2")
    ...
    def Function_8_1ADB(): pass

    label("Function_8_1ADB")
