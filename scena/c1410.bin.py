...
def main():
    ...
    ChrTalk(
        ...
        (
            "#04100F……どうやら、\x01",
            "急ぎの仕事のようRight.\x02\x03",
            "何か用があれば、いつでも言Huh\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#04100FWazy…来ていたのか。\x02\x03",
            "店で寛#2Rくつろ#ぎたい時はいつでも言Huh\x01",
            "すぐに席を用意するからな。\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#04100F店で寛#2Rくつろ#ぎたい時はいつでも言Huh\x01",
            "すぐに席を用意するからな。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00000F（２人とも、何だか楽しYeah we should）\x02",
    )
    ...
    ChrTalk(
        0xA,
        (
            "#11Pあ、あAh...それもYeah we should\x01",
            "今はこの状況に集中しないと。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#6P#00000Fああ、Yeah we should\x02",
    )
