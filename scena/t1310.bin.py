...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#12500F#6Pふむ、I see..\x01",
            "ひとまず問題はなさYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0x9,
        "#11P#13502Fふふ、Thanks for your hard work\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#11P#12502FよAhhど、How's that?\x02",
    )
    ...
    ChrTalk(
        0xB,
        (
            "#12P#12700Fいわゆる、『サンドクラフト』True.\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#11P#12503Fう〜ん、なかなか難しYeah we should\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#11P#12505Fそうだ、That's right..\x01",
            "この城って名前はあるのか？\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#11P#12500FみっしぃはおなじみBut…\x02\x03",
            "#12503Fバンバンっていうのは、\x01",
            "フランのお気に入りの\x01",
            "ヌイグルミだったっけ。\x02\x03",
            "#12509FHaha…どっちもかなり\x01",
            "趣味が入ってるなあ。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#11P#12506F（な、なにげに責任重大Right.）\x02\x03",
            "#12500Fうーん、そうだなAh...\x02",
        )
    )
    ...
    ChrTalk(
        0xB,
        "#12P#12702FEheThat's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#11P#12509Fはは、丸く収まったみたいRight.\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#11P#12509FNo prob, leave it to us\x02\x03",
            "#12500Fツァイトには……\x01",
            "フランクフルトでいいかな？\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "ロイドはキーアに\x01",
            "大きな『ホワイトストーン』Handed over Bitter Tomato Paste\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0xF,
        (
            "#12P#13600FあAh...どれも大きさは\x01",
            "大して変わらないみたいRight.\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#5P#12512Fは、はHaha…\x01",
            "どうやら負けちゃったみたいRight.\x02\x03",
            "#12500Fキーアとシュリのは\x01",
            "同じくらいみたいだし、\x01",
            "今回は２人の勝ちってことで。\x02",
        )
    ...
    ChrTalk(
        0x104,
        (
            "#12800F#6Pおお、Yeah we should\x02\x03",
            "#12809Fやっぱビーチに\x01",
            "パラソルとかは定番だろ!\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "#12504F#6PI see…\x01",
            "頑張っているみたいRight.\x02\x03",
            "#12505FThat's right..\x01",
            "アルカンシェルの舞台、\x01",
            "リニューアルするんだって？\x02",
        )
    )
    ...
    ChrTalk(
        0x9,
        (
            "#13509F#11PEhe, that's true\x02\x03",
            "#13510F多分、イリアさんの導きと\x01",
            "シュリちゃん自身の頑張りが\x01",
            "あったからだと思います。\x02\x03",
            "#13508F……私なんかよりずAhh\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00307F#1K#1P#Nおお!\x02",
    )


    ChrTalk(
        0x105,
        "#10407F#1K#2P#NあAh!\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#11P#12500FYes, I'll leave it to you\x02\x03",
            "#12503Fなんせ、ただでさえ\x01",
            "おかしな性質を持った魔獣だ。\x01",
            "十分に注意してくれ。\x02",
        )
    ...
    ChrTalk(
        0x109,
        (
            "#6P#10103FI see..ありそうTrue.\x02\x03",
