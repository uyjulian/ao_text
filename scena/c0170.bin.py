...
def main():
    ...
    ChrTalk(
        0x8,
        (
            "本日もご来店That's fine, thank you\x01",
    ...
    ChrTalk(
        0x104,
        (
            "#00305Fへえ、そいつは景気のいい話Right.\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "どうか外が落ち着くまでは、\x01",
            "皆さんを屋外に出さないよう\x01",
            "引き続きPleased to make your acquantiance\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#00100Fどうも、That's fine, thank you\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "ロイドはシンに\x01",
            "『チクタクみっしぃ』Handed over Bitter Tomato Paste\x07\x00\x02",
        )
    )
