...
def main():
    ...
    ChrTalk(
        0x109,
        "#10102Fどうも、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x19,
        (
            "#5P#02306Fチッ、I see…まあいいや。\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#6P#10302F（フフ、体よく主任を押し付けたねHuh）\x02",
    )
