...
def main():
    ...
    ChrTalk(
        0x8,
        (
            "#5P#07004FEhe, you reap what you sow\x02\x03",
            "#07008FIt's nostalgic…\x02\x01",
    ...
    ChrTalk(
        0x8,
        (
            "#5P#07003FSenpai, come on\x02\x03",
    ...
    ChrTalk(
        0x9,
        (
            "#12P#11504FHaha一本取られたな。\x02\x03",
            "#11500F──約束はできんが\x01",
            "まあ、努力はしてみるさ。\x02\x03",
            "So wait for me on that\x02",
        )
    )
    ...
    ChrTalk(
        0x9,
        (
            "#11503F#11PYeah. I was her senpai at school\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "先輩にあたる情報将校か……\x02\x03",
            "#10302FHeh, it gets better and better\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#11PExcuse us, Your Excellency\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#00104F#11PWell then we will \x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00102FWe are honored to be invited\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00100FIt was several years ago\x02",
        )
    )
    ...
    ChrTalk(
        0xA,
        (
            "#07505F#5PYes yes, and that Cult\x02\x03",
            "#07503F《Ｄ∴Ｇ教団》──\x01",
            "大陸各地で悪さをしていたが、\x01",
    ...
    ChrTalk(
        0xA,
        (
            "#07509F#5PHaha, stop being so humble\x02\x03",
            "何でも警備隊すら操られていた\x01",
    ...
    ChrTalk(
        0x102,
        "#00103FWe are honored to hear your kind words\x02",
    )
    ...
    ChrTalk(
        0xA,
        (
            "#07504F#5POh it's not strange at all\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#11232F#40W……それに…#500W…#40Wお父さんも……!\x02",
        )
    )
