...
def main():
    ...
    ChrTalk(
        0x102,
        "#00106F#3399V#11P#40WBelle…どうして……\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#10804F#5PウHahキーアさん。\x02\x03",
            "あんな風にロイドさんは\x01",
            "言ってますけど……\x02\x03",
            "#10811Fどうする#8R噵　噵　噵　噵#つもりですの？\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "この事態を何とかできるのは\x01",
            "君しかいない#12R噵　噵　噵　噵　噵　噵#ということを──\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00010F#3322V#6P#N#30W#15AAh…!\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#00307F#2766V#6P#N#30W#20Aビビんな、相手は一人だ!\x02",
    )
    ...
    ChrTalk(
        0x103,
        (
            "#00207F#2684V#12P#N#30W#25Aエイオンシステム全開!\x01",
            "目標を撃破します…!\x02",
        )
    )
    ...
    ChrTalk(
        0xA,
        (
            "#05806F#3627V#5P#40W#15A……分かった……\x02\x03",
            "#25A#05801F#3628V#30Wもう……\x01",
            "迷ったりしないから…!\x02",
        )
    )
    ...
    AnonymousTalk(
        0x101,
        "#00007F#3323V#4S#16A#30Wやめろおおおおっ…!\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "#3629V#40WLloyd……みんAh………\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00307F#2767V#11P#30W#15Aおい、どこに…!\x02",
    )
    ...
    ChrTalk(
        0x9,
        "#10503F#4058V#5P#40W#30AあAhh!その通りだ。\x02",
    )
