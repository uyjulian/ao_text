...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "It sounds like the Director called them\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#6P#00000FYeah, let's head to the entrance on the first floor.\x02",
    )
    ...
    ChrTalk(
        0x14,
        "#01002F#5POh, that's good work they did\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#5PHaha…キーアが\x01",
            "飛び上がって喜びYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00002F#11POh hey Ryu and Henry.\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#11PNo way of course.\x02\x03",
            "#00002Fでも一応、支援課で\x01",
            "使えることになったんだ。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00005F#11POh is that right?\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00108F#11PI wonder what happened\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#01002FNow that you have a quick way to get around\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00000F#11POh yeah that's true\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00102F#11PNoel, can we rely on you again?\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00100F#11POk then let's go.\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00002F#12PGot it. We'll leave it to you\x02\x03",
            "#00004F……うーん、キーアが\x01",
            "驚く顔が目に浮かぶなぁ。\x02",
        )
    )
    ...
    ChrTalk(
        0x17,
        "#01105F#12PHuh, what's wrong?\x02",
    )
    ...
    ChrTalk(
        0x17,
        (
            "#01110F#11PA white bird!\x02\x03",
            "#01109Fクチバシも尖ってて\x01",
            "カッコイイー!\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#6P#00108FW-what should we do?\x02\x03",
            "#00101Fまさかそんな訳は\x01",
            "無いとは思うんBut…\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        (
            "#00206F#12PThat's right..\x02\x03",
            "#00200Fノエルさんの運転も\x01",
            "今日が最後なんですよね。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000Fこの先は西クロスベル街道Right.\x02\x03",
            "手配魔獣がいるけど……\x01",
            "まずは市内の仕事を片付けよう。\x02",
        )
    )
