...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "無用な気を回す余裕があるなら\x01",
            "その身を癒すのに専念するんRight.\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x3),
            "#11P#60W#10A#00700F………おおおおUh…\x07\x00\x02",
        )
    )
