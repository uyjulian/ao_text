...
def main():
    ...
    ChrTalk(
        0x9,
        (
            "#04805F#5Pあれ、What's wrong?\x02\x03",
    ...
    ChrTalk(
        0x103,
        (
            "#00203F#12P#NI see..\x01",
            "貴方の仕業だったんTrue.\x02\x03",
            "#00201F導力ネットのハッキングに使われた\x01",
            "不可解なコードを開発したのRight.\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00310F#12P#30W#Nグッ……まさかThat was…\x02",
    )
    ...
    ChrTalk(
        0xF,
        (
            "#01403F#5PRed Constellationが動いたとすれば\x01",
            "Heiyueの動きもあるはずだ……\x02\x03",
