...
def main():
    ...
    ChrTalk(
        ...
        (
            "Huh?　支援課か……\x01",
            "どうやらお互い進展はなさYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00001F（Ah…さすがに険悪なムードRight.）\x02",
    )
