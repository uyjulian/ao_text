...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00000FYes, I'll leave it to you\x02\x03",
            "#00004Fそういえば、\x01",
            "山岳地帯にいる神狼たちも\x01",
            "手伝ってくれるんだったな？\x02",
        )
    ...
    ChrTalk(
        0x8,
        (
            "#11P#10709FEhe, thank you so much\x02\x03",
            "#10704F……私はしばらく、\x01",
            "ここで風に当たっています。\x02\x03",
            "#10702F急ぐ必要はありませんから、\x01",
            "ゆっくり準備を済ませて来てください。\x02",
    ...
    ChrTalk(
        0x101,
        "#00006F#12PI see….ちょっと心配Right.\x02",
    )
    ...
    ChrTalk(
        0xB,
        (
            "#05524F#2700V#5P#40WEheあったかいです……\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00007F#12P#4Sえええ!？#3S\x02\x03",
            "#00011FW-wait a second\x01",
            "それじゃあまるで…!\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x2),
            "ロイドとティオは\x01",
            "Ω#2Rオメガ#ストライク嘨を習得した。\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00308F嘆『ロイド、わたし不安なの……』\x02\x03",
            "#00301F嘇『大丈夫だ、俺が付いている』\x02\x03",
            "#00309F嘊『ガバーッ!』っていう\x01",
            "黄金コンボが使えるだろうが。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#6PRed Constellation……\x01",
            "聞いていた以上の戦闘力Right.\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00300Fあれは、Red Constellationで行われる\x01",
    ...
    ChrTalk(
        0xC,
        (
            "#00302F#11PYes, I'll leave it to you\x02\x03",
    ...
    ChrTalk(
        0xC,
        "#00302F#2781V#5P#40WHahaYeah we should\x02",
    )
    ...
    ChrTalk(
        0xC,
        "#00315F#2782V#5P#40WあAhh!繰り出すとすっか!\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#6PI see…まあ一時的に\x01",
            "待機してくれるだけでも助かるよ。\x02\x03",
            "#00013Fそうなると、俺たちの役割が\x01",
            "ますます重要になりYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#12PThat is…誰だって同じさ。\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#11PDon't talk about yourself like that\x02\x03",
            "#00001F……でも“印”って、\x01",
            "ひょっとしてワジが戦闘中に\x01",
            "たまに見せることがある.......?\x02",
        )
    ...
    ChrTalk(
        0x101,
        (
            "#00008F#6P#30W…So that happened………\x02\x03",
            "#00006F.............…\x02",
        )
    )
    ...
    ChrTalk(
        0xE,
        (
            "#10405F#5P#30WあAhh!当然だろう？\x02\x03",
            "#10403F里人たちの拠り所を\x01",
    ...
    ChrTalk(
        0xE,
        "#10404F#2430V#5P#40W#12A……くAh……\x02",
    )
    ...
    ChrTalk(
        0xE,
        "#10409F#2431V#50W#5P#4S#15Aアハハハハハハハハッ!\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00002F#6P#30W#N……すごい満月Right.\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00008F#12P#30W前もそんな事を言ってたAh…\x02",
    )
    ...
    ChrTalk(
        0x8,
        "#10720F#11P#3269V#70W#20A……うう……ああUh…\x02",
    )
    ...
    ChrTalk(
        0x8,
        "#10713F#11P#3270V#90W#30A#4S…………あああああUh…!\x02",
    )
