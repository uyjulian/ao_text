...
def main():
    ...
    ChrTalk(
        0x101,
        "#00002F#5PYeah, that's great\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00000F#5PYes, leave it to us\x02",
    )
    ...
    ChrTalk(
        0x103,
        (
            "#5P#00204FWell then let's begin\x02\x03",
            "#00200Fリンさんたちのエニグマ嘦の\x01",
            "固体番号は入力済みですか？\x02",
        )
    )
    ...
    ChrTalk(
        0xB,
        "#12PIt's already programmed into the device\x02",
    )
    ...
    ChrTalk(
        0x103,
        (
            "#5P#00203F#30WAeon System, activate\x02\x03",
    ...
    ChrTalk(
        0xA,
        (
            "#02304F#6PConfirmed link\x02\x03",
    ...
    ChrTalk(
        0x103,
        "#5P#00201F#2683V#40W#20AActivate sensors\x02",
    )
    ...
    ChrTalk(
        0x103,
        (
            "#5P#00203F#2281V#20A#40Wエイオンシステム─#800W─\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00201FQuite far south from here\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xD),
            "#12302F#11PThank you.\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xD),
            "#12301F#12PYeah…わかった。\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#02903Fここで降りるか──\x01",
            "それとも全てを叶えるか#14R噵　噵　噵　噵　噵　噵　噵#。\x02\x03",
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xD),
            "#11P#12304F#3634V#40W#55Aロイドやエリィ、ティオやランディ、\x01",
    ...
    ChrTalk(
        0xC,
        "#11307F#4S#12Aこんな事も可能になるのだよ!\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "#30W《至宝》の力を受けつつ\x01",
            "自在に操る事が出来Yeah we should\x07\x00\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "#3787V#30W#30AウHahその通りですわ。\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#5P#00011F#6P#Nこ、That voice is\x02",
    )
    ...
    ChrTalk(
        0xC,
        (
            "#11310F#6P#NBelle…これは一体.......?\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#10410F#12P#NNo way…そう来るとはね。\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "Hehe, what are you saying now\x02\x03",
            "キーアさんならほら、\x01",
            "そこからも見えているでしょう？\x02\x03",
            "あの《碧の大樹》こそ\x01",
            "キーアさんそのもの#8R噵　噵　噵　噵#ですわ。\x07\x00\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "Do not worry about that\x07\x00\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "If you would, please look after her\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        "#00206F#6P#NW-what are you saying…\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#00310F#6P#NI have no idea what you're saying\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "Yeah I know what you mean\x02\x03",
            "でも楽しければ\x01",
            "それでいいんじゃない？\x02\x03",
            "ね、リーシャ噴\x07\x00\x02",
        )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "That's part of our contract as well\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x13,
        (
            "#5P#04709FHahah, well then excuse me\x02\x03",
            "#04704F無駄だとは思うが\x01",
            "せいぜい足掻いてみたまHuh\x02\x03",
            "#04702F有意義なデータを\x01",
            "残してもらう意味でもねぇ。\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        (
            "#10108F#12PW-what in the world…\x02\x03",
    ...
    ChrTalk(
        0x104,
        "#00301F#6PAre things ok down below?\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "Lloyd explained what they had seen and heard\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        "#13P#10402FEhe, I figured you'd say that\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00601FI'll be coming along too\x02",
        )
    )
