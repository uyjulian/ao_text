...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#11P#00005FThat's right..\x02\x03",
            "#00000Fヨナのやつ、\x01",
            "出口に通じる直通リフトが\x01",
            "あるとか言ってたな？\x02",
        )
    ...
    ChrTalk(
        0x101,
        "#6P#00002FあAh...Yeah we should\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00005Fおっと、こっちは元来た道Right.\x02\x03",
            "#00000Fせっかくだから、\x01",
            "直通リフトを使って地上に戻ろう。\x02",
        )
    )
