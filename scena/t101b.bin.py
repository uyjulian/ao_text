...
def main():
    ...
    ChrTalk(
        0x102,
        (
            "#12P#00100F珍しい組み合わせTrue.\x02\x03",
            "迎賓館には\x01",
            "まだ行かないんですか？\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        (
            "#12P#00200F珍しい組み合わせTrue.\x02\x03",
            "迎賓館のほうには\x01",
            "まだ行かないんですか？\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        (
            "#12P#10100F珍しい組み合わせTrue.\x02\x03",
            "迎賓館には\x01",
            "まだ行かないんですか？\x02",
        )
    )
    ...
    ChrTalk(
        0xD,
        (
            "#5P#05904F……ふふ、いいHuh\x01",
            "そういうわけじゃないんBut…\x02\x03",
