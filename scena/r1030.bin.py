...
def main():
    ...
    ChrTalk(
        0x101,
        "#00012Fど、どうもThat's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000Fこっちはベルガード門方面Right.\x02\x03",
            "警察学校まで\x01",
            "無用な寄り道はしないでおこう。\x02",
        )
    )
