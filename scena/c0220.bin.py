...
def main():
    ...
    ChrTalk(
        0xFE,
        (
            "#02205Fふむ、Is that right\x02\x03",
            "#02203F….\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#11P#00001Fエマ捜査官も、Thanks for your hard work\x01",
            "……イアン先生の家宅捜索ですか？\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00004FすみませんThanks for that\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000Fええ、That's fine, thank you\x02\x03",
            "#00003F……それじゃあ、\x01",
            "早速捜査に当たるとしよう。\x02",
        )
    )
