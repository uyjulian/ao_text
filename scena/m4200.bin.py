...
def main():
    ...
    AnonymousTalk(
        ...
        (
            ...
            "  最近は良い関係を築けてThere he is…）\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00001Fこれは２人が使ったボートRight.\x02\x03",
            "――とにかく、急いで奥に向かおう。\x02",
        )
    )
