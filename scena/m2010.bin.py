...
def main():
    ...
    DeclMonster(3560,    15590,   4294963296, 0x1010000,    "BattleInfo_31C", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(4294954926, 15540,   4294959296, 0x1010000,    "BattleInfo_280", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(4294839706, 4294965716, 0,       0x1010000,    "BattleInfo_3B8", 0,   20,  0xFFFF, 4,  5)
