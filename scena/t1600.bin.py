...
def main():
    ...
    ChrTalk(
        0x9,
        (
            "#12P#11208FAha, is that right\x01",
            "フランさんの事はセシルさんに\x01",
            "聞いてましたけど……\x02",
        )
    )
