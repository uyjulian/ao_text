...
def main():
    ...
    ChrTalk(
        ...
        (
            "#12401Fああ、それもあるが……\x01",
            "少々厄介な問題もある。\x02\x03",
            "#12400FCan I ask you to search for him?\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "Can I ask you to search for him?\x02",
        )
    )
    ...
    ChrTalk(
        0x18,
        (
            "#12405FHmm, if I had to guess\x02\x03",
            "#12400Fいかがわしい場所、\x01",
            "あるいは賑やかな場所を\x01",
            "好む傾向にあるだろう。\x02\x03",
    ...
    ChrTalk(
        0x18,
        (
            "#12404FThat sounds likely…\x02\x03",
            "#12400F……実は、歓楽街は\x01",
            "すでに一通り探し終えていてな。\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00012FNo, that's no problem\x02\x03",
    ...
    ChrTalk(
        0x18,
        (
            "#12400FI'll leave it to you\x02\x03",
            "連れてくるのに苦労するなら\x01",
            "多少、痛い目にあわせても\x01",
            "構わないからな。\x02",
        )
    ...
    ChrTalk(
        0x101,
        (
            "#00005FSpot investigations\x02\x03",
    ...
    ChrTalk(
        0x102,
        (
            "#5P#00106FYeah I know.鉄道公社の人や\x01",
            "帝国・共和国の臨検官も\x01",
            "国外退去させられたみたいだし。\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        "#00200FShe was pretty foul mouthed\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00206FI've had enough of that old lady\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00109FHaha, nice work today\x02",
    )
