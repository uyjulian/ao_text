...
def main():
    ...
    ChrTalk(
        0x104,
        (
            "#00306F……た、確かに面倒Yeah we should\x01",
            "肝に銘じとくとするぜ。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "クロスベルで好き放題やって\x01",
            "どこかへ去っていったRed Constellationは、\x01",
            "飛行艇を持っていたそうだね。\x02",
        )
    )
    ...
    ChrTalk(
        0x14,
        (
            "#07902FThanks for your hard work\x02\x03",
            "#07906FHmm…\x01",
            "今日は何の用で来たの？\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "申し訳ないけど……\x01",
            "そう報告するしかなさYeah we should\x02\x03",
            "#00006FはAh...フランツの話を\x01",
            "ちゃんと聞いておけばよかったか。\x02",
        )
    )
