...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#6P（ええ、That's fine, thank you）\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#5PあAh...ここまで用意周到だと\x01",
            "ただのミラ目当てでも無さそうだ。\x02\x03",
            "#00013F皆さんは建物の中にいて下さい。\x01",
            "事態が収拾するまで、\x01",
            "決して外に出ないようPlease do\x02",
        )
    )
