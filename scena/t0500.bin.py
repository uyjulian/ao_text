...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#5PYeah, let's do that\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00002F#5Pはは、そういえばYeah we should\x02\x03",
            "#00000F軍用犬の事件や\x01",
            "僧院の探索で一緒だったか。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#11PYeah, let's do that\x02\x03",
            "#00000F町長の家は、町に入って\x01",
            "まっすぐ行った突き当りになるな。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00002F#11Pはは、そういえばYeah we should\x02\x03",
            "#00000F軍用犬の事件や\x01",
            "僧院の探索で一緒だったか。\x02",
        )
    )
    ...
    ChrTalk(
        0x17,
        (
            "#07904F#5PどうやらRed Constellationも\x01",
            "一通り撤退したみたいね。\x02\x03",
            "#07902F略奪をした形跡も\x01",
            "特にないみたいだし。\x02",
        )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00201FRed Constellationの猟兵というのは\x01",
    ...
    ChrTalk(
        0x104,
        (
            "#00300F#11PHaha…遅まきながらだがな。\x02\x03",
            "#00309Fいや〜、お前さんにも\x01",
            "随分心配をかけちまったなぁ。\x02",
        )
    )
