...
def main():
    ...
    AnonymousTalk(
        ...
        (
            scpstr(0x18),
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "#4119V#30WあAhh!その通りだ。\x07\x00\x02",
        )
    )
    ...
    NpcTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x3),
            "#1S#11P#50WUgh…ゲホゲホ……\x07\x00\x02",
        )
    )
