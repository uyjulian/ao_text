...
def main():
    ...
    ChrTalk(
        0x102,
        (
            "#00108FThat is one possibility\x02\x03",
    ...
    ChrTalk(
        0x104,
        "#00306FR-right there's no way\x02",
    )
