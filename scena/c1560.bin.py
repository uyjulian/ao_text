...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "全ての禍根#10R噵　噵　噵　噵　噵#を潰しておけば\x01",
            "こうはならなかった筈ですが？\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#5P#11303FThe Child's will had to be respected too\x02\x03",
            "#11301F支援課の関係者に\x01",
            "思い切ったことまでは出来ない。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#04504FHeiyue and the Resistance\x02\x03",
            "#04502F本気#4R噵　噵#で狩らせてもらいますよ？\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#04500F剣聖や、あの御仁#8R噵　噵　噵　噵#のような。\x02",
        )
    )
    ...
    ChrTalk(
        0xB,
        (
            "#5P#01603FThey're a monsterous parent and child\x02\x03",
