...
def main():
    ...
    ChrTalk(
        0x101,
        "#00005F#5PThe Phantom Flame plan…\x02",
    )
    ...
    ChrTalk(
        0x9,
        (
            "#03903F#6P……And one more person\x02\x03",
    ...
    ChrTalk(
        0x9,
        (
            "#03903F#6PHah少々謎めいた人物でな。\x02\x03",
    ...
    ChrTalk(
        0x9,
        (
            "#03903F#5PUgh此度#4R こ たび#の顛末については\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "#03901Fその意味で、Red Constellationとやらも\x01",
            "それを雇ったクロイス家の当主も\x01",
            "個人的には許しがたい。\x02\x03",
