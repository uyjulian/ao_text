...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#05200Fふう、なんとかやりきったAh…\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xA),
            "#05200FAh...\x01",
            "Thanks for your hard work\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xA),
            "#05202FThat's fine, thank you\x07\x00\x02",
        )
    )
