...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#11PあAh...\x02\x03",
            "#00007FみんAh!装備の確認を!\x01",
            "絶対にキーアを取り戻すぞ!\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000FHaha…イリアさんらしいTrue.\x02\x03",
            "#00005Fそういえば、ここには\x01",
            "『願いを叶える鏡』ってものが\x01",
            "置かれているって話でしたけど。\x02",
        )
    ...
    ChrTalk(
        0x135,
        "#01809Fは、はいっ、That's fine, thank you\x02",
    )
