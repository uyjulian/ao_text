...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#5P……ああ、Yeah we should\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00013Fそれに……今はHeiyueより\x01",
            "Red Constellationの方が優先だ。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "合ってくるのは確かだ。\x02\x03",
            "#00008Fその場合、Red Constellationや《結社》は\x01",
    ...
    ChrTalk(
        0x102,
        "#00105F#12Pど、What do you mean?\x02",
    )
    ...
    ChrTalk(
        0x103,
        (
            "#00205F#6Pええ、That's true\x02\x03",
            "#00201F……!?\x02",
        )
    )
