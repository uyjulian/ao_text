...
def main():
    ...
    ChrTalk(
        0x109,
        (
            "#10109F#11PはAh...新車の薫りがする……\x02\x03",
    ...
    ChrTalk(
        0x8,
        (
            "#01004F#11Pさすがは天下のＺＣＦRight.\x02\x03",
            "#01002F俺も個人的に一台、\x01",
            "乗り回したいくらいだぜ。\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        "#01003F#6PA one eyed red haired man\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#01001F#6PThat's the problem \x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#01000FNot to mention the trade conference this month\x02\x03",
            "You guys are gonna get really busy\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00002F#5Pはは、Yeah we should\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00012F#6Pはは、凄い説得力Right.\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00312F#40W───そう来たかよ#12R噵　噵　噵　噵　噵　噵#。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00006F#5Pっと、At a time like this\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "Park in front of the entrance\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        (
            "#00306F#5P#30WあAh...\x02\x03",
            "#00303F高級クラブ《ノイエ＝ブラン》を\x01",
            "経営する帝国籍の会社……\x02\x03",
            "#00311Fしかしその実態は──\x01",
            "猟兵団Red Constellationが持っている\x01",
            "資金調達用のダミー会社だ。\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "This is Sergei. Can you hear me?!\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#5P#00005FWaterfront district?\x02",
    )
    ...
    ChrTalk(
        0x105,
        "#6P#10301FIt seems fine there\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#5P#00011FRight, there's that too\x02",
    )
