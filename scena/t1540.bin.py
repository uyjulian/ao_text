...
def main():
    ...
    ChrTalk(
        0x8,
        (
            "#5P#01304Fまだまだ大変な時が続きそうBut…\x02\x03",
    ...
    ChrTalk(
        0x103,
        "#00204FYes…That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#10100F……That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000FThat's fine, thank you\x02\x03",
