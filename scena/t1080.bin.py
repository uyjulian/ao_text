...
def main():
    ...
    ChrTalk(
        0xE,
        "#01809Fはい、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x14,
        (
            "#02911F#3771V#5P#40W──よき滞在を#10R噵　噵　噵　噵　噵#。\x01",
            "存分に羽を伸ばして下さいな。\x02",
        )
    )
