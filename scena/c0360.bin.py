...
def main():
    ...
    ChrTalk(
        0x101,
        "#00000Fあ、あAh...Yeah we should\x02",
    )
    ...
    ChrTalk(
        0x104,
        (
            "#00305F……ど、What do you mean?\x02\x03",
            "婆さんの所有する\x01",
