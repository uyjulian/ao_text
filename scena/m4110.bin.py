...
def main():
    ...
    Sepith("Sepith_E79", 2,   3,   4,   3,   2,   0,   2)
    Sepith("Sepith_E81", 3,   0,   4,   2,   3,   4,   0)
    Sepith("Sepith_E71", 2,   7,   2,   2,   0,   3,   0)
    ...
    BattleInfo(
        "BattleInfo_4A4", 0x0010, 54, 6, 45, 10, 1, 40, 0, "bm4110", "Sepith_E79", 40, 30, 20, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_540", 0x0000, 54, 6, 45, 10, 1, 20, 0, "bm4110", "Sepith_E81", 40, 30, 20, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_408", 0x0000, 54, 6, 45, 10, 1, 30, 0, "bm4110", "Sepith_E71", 40, 30, 20, 0,
        (
    ...
    DeclMonster(4294945136, 398330,  0,       0x1010087,    "BattleInfo_4A4", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(4294934887, 384950,  0,       0x101003D,    "BattleInfo_540", 0,   20,  0xFFFF, 4,  5)
    DeclMonster(4294965936, 182590,  4294957296, 0x1010160,    "BattleInfo_408", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(3150,    4294962446, 4294961296, 0x1010101,    "BattleInfo_540", 0,   20,  0xFFFF, 4,  5)
    DeclMonster(4294957436, 4294948136, 4294961296, 0x101002D,    "BattleInfo_4A4", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(288310,  3590,    0,       0x1010087,    "BattleInfo_408", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(297740,  4294962066, 0,       0x101013E,    "BattleInfo_408", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(4294946266, 4294964796, 0,       0x10100A8,    "BattleInfo_408", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(4294946566, 4294953346, 0,       0x101000F,    "BattleInfo_4A4", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(18300,   4294946476, 0,       0x101014B,    "BattleInfo_540", 0,   20,  0xFFFF, 4,  5)
    ...
    DeclActor(4294953906, 4294961296, 4294947926, 1200,    4294953906, 4294962296, 4294947926, 0x007C, 0,  3,  0x0000)
    DeclActor(4294944906, 0,       385650,  1200,    4294944906, 1000,    385650,  0x007C, 0,  4,  0x0000)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1FA, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B3A")
    Sound(14, 0, 100, 0)
    OP_74(0x0, 0x1E)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x5E0, 1)"), scpexpr(EXPR_END)), "loc_AC3")
    ...
    OP_F4(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1FA, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C8B")
    Sound(14, 0, 100, 0)
    OP_74(0x1, 0x1E)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x45, 1)"), scpexpr(EXPR_END)), "loc_C14")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    SetMapFlags(0x8000000)
    FadeToDark(300, 0, 100)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1FA, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E19")
    Sound(14, 0, 100, 0)
    OP_74(0x2, 0x1E)
    ...
    AnonymousTalk(
        ...
        (
            ...
            "#56I Earth Sepith  x50\x01\x07\x02",
            "#57I Water Sepith  x50\x01\x07\x02",
            "#58I Fire Sepith   x50\x01\x07\x02",
            "#59I Wind Sepith   x50\x01\x07\x02",
            "#60I Time Sepith   x50\x01\x07\x02",
            "#61I Space Sepith  x50\x01\x07\x02",
            "#62I Mirage Sepith x50\x01\x07\x00",
            "obtained.\x02",
        )
    )
