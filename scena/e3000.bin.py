...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#00202FIt's everyone's long awaited vacation\x02\x03",
            "みんなに楽しんでもらえるよう、\x01",
            "配慮するのはリーダーの役目では？\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00002F#6Pああ、Yeah we should\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#00206F#11Pえ、えHuh\x01",
            "それがいいかと。\x02\x03",
            "#00208F#30W……But..あの……\x02",
        )
    )
    ...
    ChrTalk(
        0xB,
        "#01105F#11PHuh, what's wrong?\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "どうも、Thanks for your hard work\x02",
        )
    )
    ...
    ChrTalk(
        0xE,
        (
            "#02904F#12Pええ、Please do\x02\x03",
            "#02902Fそれと船内にいる\x01",
    ...
    ChrTalk(
        0xB,
        "#01105F#3620V#30W#10A#11P#NAhh!\x02",
    )
    ...
    ChrTalk(
        0xE,
        (
            "#02913F#3775V#12P#30W#NEhhe\x02\x03",
            "#3776V──大切な人たちに\x01",
