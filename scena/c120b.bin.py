...
def main():
    ...
    AnonymousTalk(
        ...
        (
            ...
            "#3855VYou can all come at me\x02",
        )
    )
    ...
    ChrTalk(
        0x18,
        (
            "#04502F#6P#NHmm. Zhao's right arm\x02\x03",
            "相手をしてやってもいいが\x01",
            "用があるのは貴様のボスでな。\x02\x03",
            "#04504FEveryone move in\x02",
        )
    )
