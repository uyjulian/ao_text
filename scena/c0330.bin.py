...
def main():
    ...
    ChrTalk(
        0x9,
        (
            "#11P#03700FEhe, that's right\x01",
    ...
    ChrTalk(
        0x8,
        (
            "#03603FThat's trueそれもそうTrue.\x02\x03",
