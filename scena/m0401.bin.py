...
def main():
    ...
    ChrTalk(
        0x12,
        "#12P#03202F──では、またの機会に#12R噵　噵　噵　噵　噵　噵#。\x02",
    )
    ...
    ChrTalk(
        0xA,
        "#5P#04502FあAhh!またの機会に#12R噵　噵　噵　噵　噵　噵#。\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00003FこっちはＤ区画に繋がるゲートRight.\x02\x03",
            "……今はＣ区画に戻って、\x01",
            "地上に出るリフトを使おう。\x02",
        )
    )
