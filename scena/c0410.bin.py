...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00003FI see..となると手分けして\x01",
            "捜した方が良さYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00000FどうもThat's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x106,
        (
            "#12P#10706F……Nice to see you again\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#12P#00000Fええ、That's fine, thank you\x02",
    )
