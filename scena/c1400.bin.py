...
def main():
    ...
    ChrTalk(
        0x109,
        (
            "#12P#10108FInformation broker Nanebari, huh\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#11P#00001FYeah, let's do that\x02\x03",
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10304FWald. What's wrong?\x02\x03",
    ...
    AnonymousTalk(
        ...
        (
            ...
            "What's the meaning of that, huh?\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10306F#30WI don't have any meaning that concerns you\x02\x03",
    ...
    ChrTalk(
        0x17,
        (
            "#01601F#30W#11PてめUh…本気で言ってんのか？\x02\x03",
            "#01603Fこのオレ様と……\x01",
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10308F#30WIt's fine, leave it to me\x02\x03",
            "#10306F……ねえ、ヴァルド。\x01",
            "ひどく当たり前のことさ。\x02\x03",
            "テスタメンツにしろ\x01",
            "サーベルバイパーにしろ……\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "My job is already complete\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10304F#30WSame for you, the Saber Vipers\x02\x03",
    ...
    ChrTalk(
        0x17,
        "#11P#01609F#2809V#4S#25A#40Wハハハハハハハハハッ!!!\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#01607F#3566VOk that's enough. Don't talk anymore.\x02\x03",
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10303F#30WLloyd. Pull back\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#6P#10303F#2909V#30WThat's enough talk\x02",
    )
    ...
    ChrTalk(
        0x105,
        (
            "#5P#10301F#2910V#30W#20Aヴァルド─#800W─\x01",
            "#40W本気で行くよ#12R噵　噵　噵　噵　噵　噵#。\x02",
        )
    )
    ...
    ChrTalk(
        0x17,
        (
            "#11P#01611F#40WUgh… you bastard\x02\x03",
            "まさか今まで……\x01",
            "ずAhh手を抜いて.......?\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#11P#10303F#30WGood bye, Wald\x02\x03",
            "#10300Fこの２年……\x01",
            "けっこう楽しかったよ。\x02",
        )
    )
    ...
    ChrTalk(
        0x17,
        (
            "#11P#01610F#3569V#50W#40Aてめぇ一人抜けるなんて……\x01",
            "認めてたまるかよおおお!!\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10304FHah, Probably just cold in the rain\x02\x03",
    ...
    ChrTalk(
        0x104,
        "#12P#00305Fああ、そういやYeah we should\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#5P#00003FYes. Let's try to put them in order\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#5P#00000F(This is definitely the order)\x02",
    )
    ...
    ChrTalk(
        0x109,
        (
            "#11P#10103FYes, that seems likely\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00001FRed Constellationに仕掛けるなら\x01",
            "さすがに仮眠くらいは取るだろう。\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x0),
            "#00005FT-that voice is\x02\x03",
            "#00013FWhy do you have this number\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "I'm waiting for you in the Times\x02\x03",
            "お暇でしたら是非、\x01",
    ...
    ChrTalk(
        0x102,
        "#12P#00108FWho in the world was that\x02",
    )
    ...
    ChrTalk(
        0x109,
        (
            "#10103F#11PYes, that seems likely\x02\x03",
            "#10108F武装の整備は、戦場での生死を\x01",
            "左右するものだから……\x02\x03",
            "#10101Fランディ先輩なら絶対に\x01",
            "綿密にチェックしたはずです。\x02",
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00000Fよし、これで一通り調査は済んRight.\x02\x03",
            "市民会館へ報告に戻ろう。\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#12P#00305FYou forgot about it right?\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#6P#10106FHmm. Well it sounds like we'll be able to get it at least\x02",
    )
    ...
    ChrTalk(
        0x8,
        "#11POk this what you need right?\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#6P#00000FYes this looks like it\x02",
    )
    ...
    NpcTalk(
        0xD,
        "男の声",
        "#4SWhat was that, you asshole!\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#5P#N#4S#00007FStop it guys\x02",
    )
    ...
    ChrTalk(
        0xE,
        "#12PIt's all your falt Wazy!\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#5P#00301F(They're completely worked up)\x02",
    )
    ...
    NpcTalk(
        ...
        (
            ...
            "#13902FAnd how about we sing instead\x02\x03",
            "混沌とした心を解きほぐし\x01",
            "やがて人々を結びつけるような、\x01",
            "そんな優しくも切ない歌を……\x02",
        )
    ...
    ChrTalk(
        0xD,
        "#12PI think I have something to do. Later\x02",
    )
    ...
    ChrTalk(
        0xE,
        "#12P#5AWhat was that blonde dude\x02",
    )
    ...
    NpcTalk(
        ...
        (
            ...
            "#13904FOh I plan on having so much more fun\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00001F(Yeah, the blonde with a white coat)\x02\x03",
            "#00006F（ミュラーさんは\x01",
            "  厄介な人物だって言ってたけど……\x01",
            "  正直、予想以上Right.）\x02",
        )
    ...
    ChrTalk(
        0x18,
        (
            "#11P#13905Fアレッ、That's right..\x01",
    ...
    ChrTalk(
        0x18,
        (
            "#11P#13905FOh you guys are the rumored…\x02\x03",
            "#13904Fフッ……\x01",
            "ミュラーの心配性も相変わらずRight.\x02\x03",
            "#13912Fこの程度の時を\x01",
            "別々に過ごしたところで、\x01",
            "僕らの愛は薄れはしないのに。\x02",
        )
    ...
    ChrTalk(
        0x18,
        (
            "#11P#13904FNever mind now\x02\x03",
            "もし、キミたちが\x01",
            "ボクを見逃してくれないと\x01",
            "言うのならば……\x02\x03",
            "#13902Fどんな手を使っても\x01",
    ...
    ChrTalk(
        0x109,
        "#11P#10100FOk let's go then!\x02",
    )
