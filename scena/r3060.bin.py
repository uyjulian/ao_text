...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#03210F強敵たるRed Constellationに\x01",
            "協力して対抗するためにね。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00001F君にとって\x01",
            "一番大切なものはなんだ？\x02\x03",
            "Red Constellationへの復讐か？\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#3273V#45Aそんなの言えるわけ……\x01",
            "言えるわけないじゃないですか。\x02\x03",
            "#10706F#3274V#45A……血塗られた私が……\x01",
            "闇に生きてきた私なんかが……\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00013F俺は君に、本当に大切なものは#18R噵　噵　噵　噵　噵　噵　噵　噵　噵#\x01",
            "何か#4R噵　噵#と聞いてるんだ。\x02\x03",
            "頑張らずにはいられない……\x01",
            "君の魂が求めずにはいられない\x01",
            "大切なものは何なんだ？\x02",
        )
    ...
    ChrTalk(
        0x8,
        "#03204F#60W#2S#11P#12A……HahaハHaha\x02",
    )
    ...
    ChrTalk(
        0x8,
        "#03209F#4S#11P#15Aアハハハハハハハハハハッ!!\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#03210F#5PHahaさすがはロイドさん。\x02\x03",
            "見事、こちらの段取りを\x01",
    ...
    ChrTalk(
        0x8,
        (
            "#03204F#5Pふむ、そうTrue.\x02\x03",
            "#03202Fリーシャさんに去られる代わりに\x01",
            "貴方にHeiyueに来て頂きましょうか。\x02\x03",
