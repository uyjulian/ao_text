...
def main():
    ...
    DeclMonster(4294948066, 70,      0,       0x1010000,    "BattleInfo_238", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(22310,   4294958316, 1990,    0x1010000,    "BattleInfo_300", 0,   18,  0xFFFF, 2,  3)

    DeclActor(4294963566, 2000,    4294943236, 1200,    4294963566, 3500,    4294943236, 0x007C, 0,  2,  0x0000)
