...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#6PI see. So that' what you mean\x02\x03",
            "#00009Fはは、それじゃあ\x01",
            "これから楽しみRight.\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00000F#6P……そろそろ到着みたいRight.\x05\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00000F#6Pはは、Yeah we should\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00009F#6Pあ、あAh...そういうことか。\x02\x03",
    ...
    NpcTalk(
        ...
        (
            "#10109Fい、いUh…\x01",
            "その、That's fine, thank you\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00000F#6PへUh…なんだか意外Right.\x02\x03",
            "#00003F俺のほうは、\x01",
            "初めて観覧車に乗るからか\x01",
            "結構緊張してるんだ。\x02\x03",
            "#00002Fはは、考えてみれば\x01",
    ...
    NpcTalk(
        ...
        "キーア",
        (
            "#01105F#11PThat's right..\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00012F#6P相当テンションが上がってるなAh...\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#6P（Hmmmセシル姉と兄貴って、\x01",
            "  やっぱりお似合いだったんだよAh…）\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#6PW-wait a minute!\x02\x03",
            "#00011F誰狙いとかどうとか、\x01",
            "矢継ぎ早に質問されても……\x01",
            "その、困りますから!\x02",
        )
