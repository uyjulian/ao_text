...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00005F#6PUhm...なにかマズかったか？\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00000F#6P……ってことだけど、How's that?\x01",
            "折角来たんだし、試しにさ。\x02",
        )
    )
    ...
    NpcTalk(
        ...
        "ティオ",
        (
            "#00203F#12P……ふむ、面白そうTrue.\x02\x03",
    ...
    NpcTalk(
        0x15,
        "ティオ",
        "#00202F#12PEhe, thank you so much\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00006F#6P……と、とにかく、Please do\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00009F#6Pはは、Yeah we should\x01",
            "俺もそうだと嬉しいよ。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00012F#6PHaha…That's fine, thank you\x01",
            "無茶なお願いをしてしまったのに……\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#6Pう〜ん、想像通りRight.\x02\x03",
            "#00000Fやっぱりフランに\x01",
            "そういう話が出るのは\x01",
            "まだまだ先っぽいな。\x02",
        )
    ...
    ChrTalk(
        0x101,
        (
            "#00000F#6Pへえ、なんだか意外Right.\x02\x03",
            "マリーの事件の時に\x01",
            "ちょっと関わったくらいだけど、\x01",
            "そんなに気になってたのか？\x02",
        )
    ...
    ChrTalk(
        0x101,
        "#00002F#6P（Haha…やっぱり誘ってよかったかな。）\x02",
    )
