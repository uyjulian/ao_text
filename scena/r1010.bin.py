...
def main():
    ...
    ChrTalk(
        0x109,
        "#10100F#12PそちらこそThanks for your hard work\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#10100F#11PそちらこそThanks for your hard work\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00205F#6Pロイドさん、Could it be\x02",
    )
