...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00003F（This is..手帳の最後の１ページが\x01",
            "  埋まったみたいだ。）\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00000Fど、どうもThat's fine, thank you\x02",
    )
    ...
    ChrTalk(
        ...
        (
            "#00006Fいや、さすがに\x01",
            "それは無謀というかHow do I put it\x02\x03",
            "#00000F……ええと、\x01",
            "でもThat's fine, thank you\x02\x03",
            "なんていうか、\x01",
            "こんなに良くしていただいて……\x02",
        )
    )
    ...
    ChrTalk(
        0x25,
        (
            "#03204FRed Constellationやルバーチェという\x01",
            "競争相手が消えた今、\x01",
    ...
    ChrTalk(
        0x109,
        "#10109Fええ、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00000FRight. We're prepared for that\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00002Fはは、でも本当に仲がいいんRight.\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#6P#00105F(We totally caught him)\x02",
    )
    ...
    ChrTalk(
        0x28,
        (
            "#03505FOh, youi're late\x02\x03",
            "#03509FI was waiting, my Best Friends\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        "#11PSo you can bring them anytime\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#6P#00105FWhat are you talking about…\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#5P#00107FW-we better chase him\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00003FThat's fine, thank you\x01",
            "そ、それじゃあExcuse us\x02\x03",
            "#00001FGuys, we're chasing him!\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00006Fそ、It looks like it\x02\x03",
            "#00000FAhem\x01",
            "すみませんが、依頼について\x01",
            "お聞かせ願えませんか？\x02",
        )
    ...
    ChrTalk(
        0x101,
        (
            "#00003FHmm, I wonder\x02\x03",
            "#00000F住宅街から旧市街にっていうのは\x01",
            "結構特殊な経歴Right.\x02\x03",
            "エリィ、住宅街に住んでいた人で\x01",
            "心当たりはないか？\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00103FHmm. Well possibly\x02\x03",
            "#00100Fあの、アルムさん。\x01",
            "お父様のお名前やご職業は\x01",
            "覚えてらっしゃいますか？\x02",
        )
    ...
    ChrTalk(
        0x101,
        (
            "#00003Fああ、Yeah we should\x02\x03",
