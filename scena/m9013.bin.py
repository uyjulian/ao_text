...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#6P#30W……〜〜〜〜Uh\x01",
            "放っておいてくれよ!\x02\x03",
            "#00002Fでも、その減らず口……\x01",
            "間違いなく兄貴みたいだAh…\x02\x03",
            "夢でもないみたいだし……\x01",
            "一体どういうことなんだ.......?\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00002F#6P#40W…………あAh...…………\x02\x03",
            "#00006F本当にそんな世界があったら、\x01",
            "どんなに楽しくて、嬉しくて……\x01",
            "……幸せだろうと思うけど……\x02\x03",
            "#00008F#50W……それBut..僕は………\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#07804F#11P#30WあAhh!それでいい。\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00002F#6P#30WHaha…俺もそう思うよ。\x02\x03",
            "#00006Fできれば兄貴にも……\x01",
    ...
    ChrTalk(
        0x8,
        (
            "#07804F#11P#30WI see…すごく良い顔で\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00002F#6P#30WHaha…先走りすぎだって。\x02\x03",
            "#00006F……できれば兄貴にも\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#6P#30WあAh...俺もそう思うよ。\x02\x03",
            "#00008Fできれば兄貴にも……\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00012F#6P#30WHaha…否定できないな。\x02\x03",
            "#00008Fできれば兄貴にも……\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00012F#6P#30WHaha…分かった。\x02\x03",
