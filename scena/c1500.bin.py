...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "どうぞPleased to make your acquantiance\x02",
        )
    )
    ...
    ChrTalk(
        0x22,
        (
            "#02503F……うむ、その通りRight.\x02\x03",
            "#02500Fとにかく、今は目の前にある問題を\x01",
            "一つ一つ解決していくとしよう。\x02\x03",
            "若い君たちには\x01",
            "大変な苦労をかけてしまうが……\x01",
            "今しばらく力を貸してくれたまHuh\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "Popularly called \"The Orchis Tower\"\x02\x03",
    ...
    ChrTalk(
        0x30,
        (
            "#02804F#5PVisitors from every country\x02\x03",
    ...
    ChrTalk(
        0x30,
        (
            "#02803F#N#11PI will provide an introduction.\x02\x03",
            "The new Crossbell City Hall\x02\x03",
    ...
    ChrTalk(
        0x30,
        "#02809F#N#4S#11PThis is the Orchis Tower!\x02",
    )
    ...
    ChrTalk(
        0x2C,
        (
            "#07104F#5P（えUh…さすがに中枢塔#6Rアクシスピラー#ほどの\x01",
            "  高さではありませんが……）\x02",
        )
    )
    ...
    ChrTalk(
        0x27,
        (
            "#07404F#11P(Hehe, what a wonderful, practical thing)\x02\x03",
            "#07400F（この因縁の地に\x01",
    ...
    ChrTalk(
        0x30,
        (
            "#02804FWell then once again\x02\x03",
            "首脳の方々、およびこの場にいる\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#11PSo then what do we do?\x02\x03",
            "#00001Fダドリーさんとは\x01",
            "正午に１Ｆの玄関フロアで\x01",
            "待ち合わせているけど。\x02",
        )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00300FSomething might happen\x02",
        )
    )
    ...
    Menu(
        ...
        (
            "\x01",            # 0
            "Choice 2: Enter Orchis Tower\x01",      # 1
        )
    )
    ...
    ChrTalk(
        0x32,
        "#11PNot at all, we're both working hard\x02",
    )
    ...
    AnonymousTalk(
        0x103,
        (
            "#00203FThe Society of Oroborous\x02\x03",
    ...
    ChrTalk(
        0x30,
        (
            "#11303F#11PAnd one more person\x02\x03",
    ...
    AnonymousTalk(
        ...
        (
            ...
            "いかなる脅威も退けることを\x01",
            "お約束しましょう。\x02\x03",
            "#4087VAs the shield that protects Crossbell\x02\x03",
