...
def main():
    ...
    ChrTalk(
        0x12,
        (
            "#10300FさっきIliaさんが休憩所から\x01",
            "Cecilさんを引っ張っていったよ。\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00010F#6PPleomorphic grass … …!\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00107F#12P#NIt appeared in the marsh … …!\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#00310F#6P#NHappy birthday party!\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "まあIt can not be helped.\x02\x03",
