...
def main():
    ...
    ChrTalk(
        0x101,
        "#00009F（はは、本当に嬉しYeah we should）\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#05531F（これは、お仕置きが必要True.）\x07\x00\x02",
        )
    )
