...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00001FThis is…\x01",
            "ルバーチェ商会の跡地Right.\x02\x03",
            "#00003F今はもぬけの空のはずBut…\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        (
            "#11P#10106Fでも、In that case…\x01",
            "赤い星座については地道に\x01",
            "聞き込みをするしかなさそうTrue.\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00003F……鍵がかかってるみたいRight.\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#10303F#6P#NSo this is where the suspicious group ended up\x02",
    )
    ...
    ChrTalk(
        0x11,
        (
            "#03504F#5PYeah, sort of a hidden mechanism\x02\x03",
    ...
    ChrTalk(
        0x10,
        (
            "#04609F#11PHehe. I'm excited!\x02\x03",
    ...
    ChrTalk(
        0xF,
        (
            "#04503F#11PAbout 6 months ago\x02\x03",
            "He ended up in a draw with the West Wind man\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#04612FIt was really really cool!\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00300F#40WI'm sure he was satisfied\x02",
        )
    )
    ...
    ChrTalk(
        0xF,
        (
            "#04504F#11PWell, your father has no regrets\x02\x03",
            "#04501F──どこぞで迷ってる\x01",
            "不肖の息子のこと以外はな。\x02",
        )
    )
    ...
    ChrTalk(
        0xF,
        (
            "#04504F#5PThe vacation is over, Randall\x02\x03",
            "#04502Fいずれ話があるから\x01",
            "身体を開けておくがいい。\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        (
            "#00303F#11P#30WRed Constellationの副団長、\x01",
            "シグムント・オルランド。\x02\x03",
            "その娘で部隊長の一人、\x01",
            "シャーリィ・オルランド。\x02",
        )
    ...
    ChrTalk(
        0xF,
        (
            "#04504F#5PHum. Yeah I suppose\x02\x03",
            "#04502Fだがそれよりも──\x01",
            "血の予感に酔ってるんだろうさ。\x02",
        )
    )
    ...
    ChrTalk(
        0xF,
        (
            "#04504F#5PHeh, Just what I'd expect of my daughter\x02\x03",
    ...
    ChrTalk(
        0x14,
        (
            "#02100FI see. That's kind of too bad\x02\x03",
            "#02106Fしっかし、まさかワジ君が\x01",
            "支援課に入っちゃうなんてね〜。\x02\x03",
            "#02102FI'm really quite surprised\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10300FOh I'm so glad to hear that\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#02102FOnce you have time we can take our time-\x02",
        )
    )
    ...
    NpcTalk(
        0x15,
        "青年の声",
        "#NWell isn't this a rare sight to see\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#6P#10111FWh-why do you know that!\x02",
    )
    ...
    ChrTalk(
        0x15,
        (
            "#03200Fフフ、Well then excuse me\x02\x03",
            "ロイドさん、何かあれば\x01",
            "我が社にいらしてください。\x02\x03",
            "#03204FLet's go Lau\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        (
            "#12P#10101FH-he's such a cold person.\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#10306FI've heard the rumors about him\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00003FYeah. He's the same as always\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#02101FSo it's kind of dangerous.\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#02102FAre you on a different case?\x02",
        )
    )
    ...
    ChrTalk(
        0x14,
        (
            "#5P#02105FWell that's what I think anyway\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00012FS-she's the same as always\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#12P#10111FHe seriously jumped!\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#6P#00106FA-anyway let's follow\x02",
    )
    ...
    ChrTalk(
        0x1E,
        (
            "#12404FNice work you guys\x02\x03",
            "おかげで大した騒ぎになる前に\x01",
    ...
    ChrTalk(
        0x104,
        "#6P#00309FYeah it sounds pretty terrible for you\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "いつも助かっているさ。\x02\x03",
            "#13909FHe's really my virtuous gift\x02",
        )
    )
    ...
    ChrTalk(
        0x1E,
        (
            "#12400FWell then we will head out now.\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00000FNo, that's our job\x02\x03",
            "#00006Fなんというか、その……\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "  あの人はCould it be）\x02\x03",
            "#00109F(Bbut that must not be it…)\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#11P#00102FN-no, nothing at all\x02",
    )
    ...
    ChrTalk(
        ...
        (
            "#00303F……ま、ひとまず\x01",
            "一件落着ってとこだろ。\x02\x03",
            "#00300FHow about we get going Lloyd\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#11P#00000Fああ、Yeah we should\x02",
    )
