...
def main():
    ...
    ChrTalk(
        0x8,
        (
            "皆さん、Thanks for your hard work\x01",
            "こちらはオルキスタワーの\x01",
            "総合受付です。\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#00105FOH thank you very much\x02",
    )
    ...
    NpcTalk(
        0x16,
        "男の声",
        "#3454V#30W#11AYou were here\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#11P#00104FThanks for your hard work\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#00309F#5PHehe, long time no see\x02",
    )
    ...
    ChrTalk(
        0x23,
        "#02800F#11PDudley, is that ok?\x02",
    )
    ...
    ChrTalk(
        0x16,
        "#6P#00606FUgh, if that's what you want\x02",
    )
    ...
    ChrTalk(
        0x16,
        "#6P#00603FOK then Mayor, see you later\x02",
    )
    ...
    ChrTalk(
        0x23,
        "#02800F#11PYes, see you then\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#00302F#5PHe's the same as ever\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#5P#00000FYes. We should go along\x02",
    )
    ...
    ChrTalk(
        0x105,
        "#6P#10302FWow, that's pretty high tech\x02",
    )
    ...
    ChrTalk(
        0x23,
        (
            "#02804F#11PWell there are 40 floors\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#02800FLet's stop at the 34F where the guard room is\x02",
        )
    )
