...
def main():
    ...
    ChrTalk(
        ...
        (
            "早めに帰って、今後について\x01",
            "町長たちと相談したほうが良さYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00000F……That's fine, thank you\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00008F#12P(He's just admitting it)\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00103F#6PWell then my turn\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00013F(That should be the end)\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00100F#6PWe appreciate your cooperation\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00001F#12PHow do you know that much\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#03501FAnd my other goal is-\x02",
        )
    )
    ...
    NpcTalk(
        0x16,
        "少女の声",
        "#3937V#1P#30WWhat are you doing here\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "The girl bit into Lloyd's ear \x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#00115F#3391V#4S#5PきゃあああAhh!?\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#10111F#5PW-when did you get back there-\x02",
    )
    ...
    ChrTalk(
        0x16,
        (
            "#04611F#3938V#5P#30WYou're pretty huge though\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00012F#11PY-yeah really… wait no!\x02\x03",
            "#00007Fちょっと君!\x01",
            "いきなり何してるんだ!?\x02",
        )
    )
    ...
    ChrTalk(
        0x15,
        (
            "#11P#03509FAhah, she does what she wants \x02\x03",
            "#03502Fそれ以上やると\x01",
            "セクハラになっちまうぞ〜？\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#10302F#5PHah, she's no ordinary girl\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#00107F#5P#4SIT'S NOT GOOD WORK!\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00115F#5P#5SI-I'M NOT USED TO ANYTHING!\x02",
    )
