...
def main():
    ...
    ChrTalk(
        0x8,
        (
            "#04606F#3968V#6P#80W#30AはあUhはあっ…#1500W…\x01",
    ...
    ChrTalk(
        0x106,
        "#10706F#12P#40W#16AはあUhはあUh\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#04604F#5P#40WEhhe今んとこ\x01",
            "シャーリィには無理かなぁ……\x02\x03",
            "#04602FまあいNo…それじゃあ\x01",
    ...
    ChrTalk(
        0x8,
        (
            "#04606F#3979V#5P#50WあーAh...今のタイミングなら\x01",
