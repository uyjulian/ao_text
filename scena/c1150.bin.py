...
def main():
    ...
    ChrTalk(
        0x8,
        "みなさん……Thanks for your hard work\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000Fレベッカさん、Thanks for your hard work\x01",
            "本部にお戻りになったんですね？\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00001FあAh...教団がなくなったとはいえ、\x01",
            "まだ注意は必要なのかもしれない。\x02",
        )
    )
    ...
    ChrTalk(
        0x106,
        "#12P#10708F……ある意味、哀れな人たちTrue.\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#12P#10108F……ある意味、哀れな人たちTrue.\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00000FThanks a lot Rebeccaa\x02\x03",
            "#00003F俺たちの手で絶対に、\x01",
    ...
    ChrTalk(
        0x101,
        "#12P#0000Fはい、Pleased to make your acquantiance\x02",
    )
    ...
    ChrTalk(
        ...
        (
            "また何かお願いする事が\x01",
            "あるかもしれません。\x01",
            "その時はPleased to make your acquantiance\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        "#00202Fお気遣い、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#01900Fえへへ、皆さんも\x01",
            "ありがとうございます〜!\x02\x03",
            "#01904Fコホン、それじゃAh...\x02\x01",
            "#01909Fお姉ちゃん、改めてよろしくね噴\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00012F（はは、ノエルもフランには形無しRight.）\x02",
    )
    ...
    ChrTalk(
        ...
        (
            "それこそ、\x01",
            "いつものペースと言わず#22R噵  噵  噵  噵  噵  噵  噵  噵  噵  噵  噵#にね。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "とりあえずは、１つずつ\x01",
            "確実に潰して行くしかなさYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#00100Fご忠告That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0xC,
        (
            "#00601F……加えてRed Constellationや\x01",
            "Heiyueの動向のこともある。\x02\x03",
            "さらに当然、\x01",
            "それら以外の犯罪の対応にも\x01",
    ...
    ChrTalk(
        0x102,
        (
            "#00105F#5PAh...確かにそうだったわね。\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#00102Fええ、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x14,
        "#5PWe will be at full strength until the end of the meeting\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#01000FAnd that's where we step in\x02",
        )
    )
    ...
    ChrTalk(
        0x19,
        "#12P#01006FSeriously, using us like this\x02",
    )
    ...
    ChrTalk(
        0x19,
        "#12P#01005FLeave me alone, that was a long time ago\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00002FBlind Spot Sergei..\x02",
    )
    ...
    ChrTalk(
        0x19,
        "#11P#01006FThat was a long time ago…\x02",
    )
    ...
    ChrTalk(
        0xC,
        (
            "#11P#00603FYeah, that's fine\x02\x03",
    ...
    ChrTalk(
        0xC,
        (
            "#11P#00606FYes, that's right\x02\x03",
            "遊撃士協会と同じスタンスだが\x01",
            "彼らに頼り切るわけにもいかん。\x02\x03",
            "#00601Fそれに……\x01",
            "あんな連中#10R噵　噵　噵　噵　噵#が入り込んできた以上、\x01",
            "予想外の事態への保険は欲しい。\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00303FThe Red Constellation right…\x02",
    )
    ...
    AnonymousTalk(
        0xC,
        (
            "#00603FJaeger Corps, Red Constellation\x02\x03",
            "ゼムリア大陸西部において\x01",
    ...
    ChrTalk(
        0x14,
        "#5PHmm, sounds like a dangerous group\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00600FIsnt' that right, Orlando\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#10302FどうしてRed Constellationが\x01",
            "クロスベル入りしたのかっていう。\x02",
        )
    )
    ...
    ChrTalk(
        0x19,
        (
            "#12P#01006FWell, that could be the case\x02\x03",
            "#01000Fいずれにせよ、通商会議において\x01",
            "無視できる要素じゃないってのは\x01",
            "間違いなさYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0xC,
        (
            "#11P#00603FRight, of course\x02\x03",
            "#00600F──ちなみにRed Constellationだが、\x01",
            "クロスベル市の周辺にも\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "Red Constellationの情報収集を行います。\x02",
        )
    )
    ...
    ChrTalk(
        0xA,
        "#5PRight. We'll count on you\x02",
    )
    ...
    ChrTalk(
        0x9,
        "#5P#01902FOh hey guys! And big sis!\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00102FSorry for the long gap \x02",
    )
    ...
    ChrTalk(
        0x8,
        "She's waiting in the conference room here. \x02",
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00105F(Looks like a lot is going on)\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#12P#10106FW-what a crazy person…\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00100FBut why did you ask us?\x02",
    )
    ...
    ChrTalk(
        0xD,
        "That was the grounds for our decision\x02",
    )
    ...
    ChrTalk(
        0xD,
        "He'll be returning tomorrow, I believe\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00001FOh is that right\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00100FHe's busy isn't he\x02",
    )
    ...
    ChrTalk(
        0x105,
        "#12P#10302FHmm. Seems like it\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#10102FHehe I got that feeling as well\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#11P#00006FCome on\x02\x03",
            "#00000Fとにかく当たりを付けて\x01",
            "レクターさんを捜してみよう。\x02\x03",
            "First we should head to the Back Alley\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#6P#00113FI didn't stick anything out!\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#6P#00106F……はあ、Yeah I know.\x02\x03",
            "#00108Fそれにしてもあの子……\x01",
            "本当に何者なのかしら？\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "無邪気で奔放な少女か……\x02\x03",
            "#10304FHa, that's quite interesting\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        "Yes, that would really help\x02",
    )
    ...
    ChrTalk(
        0x8,
        "Right. I'll be waiting for you\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00100FRight, thanks a lot!\x02",
    )
