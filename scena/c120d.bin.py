...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#02901FあのRed Constellationとかいう\x01",
    ...
    ChrTalk(
        0x102,
        (
            "#11P#00105FThat's right..ベル。\x02\x03",
            "あなたの大事にしていた\x01",
            "ローゼンベルク人形は\x01",
            "どうなったの？\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00004F──Thanks Noel\x02\x03",
            "君の運転と、戦闘技術と\x01",
