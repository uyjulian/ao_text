...
def main():
    ...
    Sepith("Sepith_B47", 5,   5,   5,   5,   5,   5,   5)
    ...
    BattleInfo(
        "BattleInfo_2F4", 0x0000, 84, 6, 60, 8, 1, 60, 0, "br1060", "Sepith_B47", 45, 35, 20, 0,
        (
    ...
    DeclMonster(880,     4294965516, 0,       0x10100C3,    "BattleInfo_2F4", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(4294936256, 4294956646, 0,       0x1010069,    "BattleInfo_2F4", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(4294921406, 4294941236, 0,       0x101003C,    "BattleInfo_2F4", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(4294881406, 4294938536, 0,       0x101004B,    "BattleInfo_2F4", 0,   16,  0xFFFF, 0,  1)
    ...
    DeclActor(4294894996, 0,       4294960596, 1200,    4294894996, 1000,    4294960596, 0x007C, 0,  2,  0x0000)
    DeclActor(10780,   100,     4294950946, 1200,    10780,   1100,    4294950946, 0x007C, 0,  3,  0x0000)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1F6, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_87D")
    Sound(14, 0, 100, 0)
    OP_74(0x3, 0x1E)
    OP_71(0x3, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x20C, 1)"), scpexpr(EXPR_END)), "loc_806")
    ...
    def Function_3_8D3(): pass

    label("Function_3_8D3")

    OP_F4(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1F6, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9CF")
    Sound(14, 0, 100, 0)
    OP_74(0x4, 0x1E)
    OP_71(0x4, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x5EE, 1)"), scpexpr(EXPR_END)), "loc_958")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
