...
def main():
    ...
    ChrTalk(
        0x102,
        (
            "#00104F#6PYeah I know.一課の人たちを\x01",
            "羨ましがってたのが懐かしいわ。\x02",
        )
    )
