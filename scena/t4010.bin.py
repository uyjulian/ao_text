...
def main():
    ...
    ChrTalk(
        ...
        (
            "先ほど遊撃士が聞き込みに来たが、\x01",
            "エオリア君たちが行方不明だYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#04403F（……私はクロスベルに居られるうちに#13R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　　　　　　　　　　　　　#、\x01",
    ...
    ChrTalk(
        0xA,
        "#04402FThat's trueそうかもしれません。\x02",
    )
    ...
    ChrTalk(
        0xA,
        (
            "#04403FAha, is that right\x02\x03",
    ...
    ChrTalk(
        0xA,
        (
            "#04403FUnderstood\x01",
            "お心遣いThat's fine, thank you\x02",
        )
    )
    ...
    ChrTalk(
        0xA,
        (
            "#04400F……お気遣いThat's fine, thank you\x01",
            "今、着替えてきますね。\x02",
        )
    )
    ...
    ChrTalk(
        0xA,
        (
            "#6P#13802FThat's fine, thank you\x02\x03",
            "#13804F女神の名の下に、\x01",
            "謹んで勤めさせていただきます。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#5P#00000Fああ、それもYeah we should\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00104F#5PYeah I know.知的好奇心は\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#6PYeah, let's do that\x02\x03",
            "#00000Fマーブル先生。\x01",
    ...
    ChrTalk(
        0x109,
        "#10112F#6Pお、Good work everyone!\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00012Fえ、Uhm...かまいませんよ。\x02\x03",
            "#00004F（立食パーティにつられたのかAh…）\x02",
        )
    )
