...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#02109FThat's fine, thank you\x01",
            "一度、食べてみたかったんですよ〜。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "ま、とにかくしばらくは\x01",
            "黙って様子を見るしかなさYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00003FあAh...Yeah we should\x02\x03",
    ...
    ChrTalk(
        0x109,
        "#6P#10105Fあの、What would that be…\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#6P#00000Fはい、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00200FI thought that might be\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00103FIt seems interesting\x02\x03",
            "#00105Fその顔ぶれの中に\x01",
            "私たちが入って大丈夫なんですか？\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00003FYes I think I get it\x02\x03",
            "#00000FSo specifically what should we do\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "６ヶ所以上回ってくればいいんTrue.\x02\x03",
            "#00103F私たち全員のお気に入りを\x01",
            "見つけるためには\x01",
            "根気よく回る必要がありそうBut…\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00000Fはは、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00012FOH thank you very much\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00000Fええ、Well then excuse me\x02",
    )
