...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#6203F#40W５……１０……\x01",
            "どうしてAt a time like this\x02\x03",
    ...
    ChrTalk(
        0x10,
        "#04612F#3957V#11P#5S#20A#30Wアハハハハ、落っちろ〜!\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#06110F#5P#80W#2SReally…. Good…\x02\x03",
            "#2S#80W……リー……シャ………\x01",
            "次の……幕は……アンタだけで……\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#04602FI understand why you're taken with her Rixia\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "ロイドはホイッスルGot FORCE from Dudley\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00001F……果たして、本当にIs that right?\x02",
        )
    )
