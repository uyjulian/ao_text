...
def main():
    ...
    ChrTalk(
        0x101,
        "#00000Fトルタ村長、Nice to see you again\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00002F#5P……That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00006F#5PAha, is that right\x02",
    )
