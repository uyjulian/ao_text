...
def main():
    ...
    ChrTalk(
        0x103,
        (
            "#12P#00203FAlso that mysterious hacker\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "But it seems it wasn't enough\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00001FThe prediciton of someone after their lives\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#6P#10108FThe leaders of the two biggest countries\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#10301FSpecifically, are there any movements?\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#6P#00106FThat is definitley strange\x02\x03",
            "#00101Fいつも事あるごとに\x01",
            "反発し合っている２国なのに……\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#02804F#5PHah, it's fine\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#12P#00002FAha, is that right\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#6P#10101FWe're honored, Mayor!\x02",
    )
    ...
    ChrTalk(
        0x103,
        (
            "#11P#00203FえUh…えHuh\x02\x03",
            "#00202FUnderstood\x01",
            "そこまで判れば十分です。\x02\x03",
            "#00204Fご苦労でした、ヨナ。\x01",
            "それではまた後で──\x02",
        )
    ...
    ChrTalk(
        ...
        (
            ...
            "間違いはあり得なさYeah we should\x02\x03",
            "#00305F……しかし随分と\x01",
            "長いこと降り続けてるな？\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#11P#00106FYeah I know.\x01",
            "アリオスさんやRed Constellationも\x01",
            "いるかもしれないし。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#11PThat's right..\x02\x03",
