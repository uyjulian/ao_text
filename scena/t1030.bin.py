...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00009F#6Pティオ、もう来てたんRight.\x02\x03",
            "#00002Fさっきはお疲れ。\x01",
            "おかげで助かったよ。\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#00107F#1K#1PRight!\x02",
    )


    ChrTalk(
        0x103,
        "#00201F#1K#2PRoger!\x02",
    )
