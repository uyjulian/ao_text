...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#05205F#5P#40WIt's raining today\x02\x03",
    ...
    ChrTalk(
        0x9,
        (
            "#05809F#3601V#6P#60W……えへWhat…\x01",
            "シズクー……こっちだよ〜……\x02\x03",
            "#05813F#3602V#2SHmmmm…. \x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#05212F#11P#30WHaha…シズクちゃんと\x01",
            "遊んでる夢みたいRight.\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#5PIt's simple\x02\x03",
            "#00008Fもしランディが本気で\x01",
            "Red Constellationの武装活動を\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "使っていた何らかの武装……\x02\x03",
            "#01001FYou're saying first he has to procure that\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00000F#5PYeah, that's what I think\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#6P#01004FHah, all his bad traits\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#00109F#11PYes, no need to worry!\x02",
    )
