...
def main():
    ...
    ChrTalk(
        0x102,
        "#00100Fはい、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "でもそんなに褒めたって\x01",
            "何も出ないわよ？\x02\x03",
            "#01703Fと、Well that aside\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "あの時のこと#12R噵　噵　噵　噵　噵　噵#を忘れてないからな。\x02",
        )
    )
    ...
    ChrTalk(
        0x9,
        "#5P#01802Fはい、お気遣いThat's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00000FI see..そうでしたか。\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00000FNice to see you Nicol\x02\x03",
            "We have something to ask you…\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        "#6P#10100FLooking forward to seeing the show!\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#04602FEhe, show me your skill\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004FNo, it's because I was too slow\x02\x03",
            "#00000FAnyway let's go chase her\x02\x03",
            "念のためエリィたちは反対側から\x01",
            "エントランスに向かってくれ。\x02",
        )
    )
    ...
    ChrTalk(
        0x9,
        (
            "#06205F#10ANo, not on the chandelier!\x02\x03",
            "#10Aでも、一体誰が……!?\x02",
        )
    )
    ...
    ChrTalk(
        0x1A3,
        "#11P#04611F#10AHaha, I can do it!\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "Please settle down already\x02\x03",
            "#04602FHehe, how's this\x02",
        )
    )
    ...
    ChrTalk(
        0x1A3,
        (
            "#11P#04609FEhe, not bad huh?\x02\x03",
            "#04600FじゃAh...お次はこうだ噴\x02",
        )
    )
    ...
    ChrTalk(
        0x1A3,
        "#11P#04609FAhaha, so you calmed down a bit?\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00000FHaha, not too bad\x02",
    )
    ...
    ChrTalk(
        0x1A3,
        "#11P#04605FWhat are you doing!\x02",
    )
