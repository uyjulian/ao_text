...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#00013FWe have to get those guys\x02",
        )
    )
    ...
    ChrTalk(
        0x9,
        (
            "#5P#50W#2SRed Constellation……\x01",
    ...
    ChrTalk(
        0x11,
        (
            "#11P#04504FWell, this is part of the contract\x02\x03",
    ...
    ChrTalk(
        0x12,
        (
            "#12P#04611F#3950V#30WEhe, what's wrong?\x02\x03",
    ...
    ChrTalk(
        0x104,
        "#00310F#2754V#4S#6P#Nやめろおおお!!\x02",
    )
    ...
    ChrTalk(
        0x12,
        "#04605F#12POh, a nusince came in\x02",
    )
    ...
    ChrTalk(
        0x11,
        "#04504F#11PEhe, you were slow\x02",
    )
    ...
    ChrTalk(
        0x11,
        (
            "#04504F#11PI said it before, it's business\x02\x03",
            "帝国宰相、および皇族を狙った\x01",
    ...
    ChrTalk(
        0x102,
        (
            "#5P#00108FState Code Number 19 Paragraph 3\x02\x03",
    ...
    ChrTalk(
        0x11,
        (
            "#04504FHeh, exactly\x02\x03",
            "#04500Fつまりこの件に関しては\x01",
            "俺たちは帝国政府の代理……\x02\x03",
            "So it's all legal\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        "#5P#10301FVery thoughtfully prepared..\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#6P#00310F#2755V#4S#10A──叔父貴ィィッ!!\x02",
    )
    ...
    ChrTalk(
        0x12,
        (
            "#04606FHuh, how wasteful…\x02\x03",
            "#04600Fま、いっか。\x01",
            "ザコだと遊び甲斐がないし。\x02",
        )
    )
    ...
    ChrTalk(
        0x11,
        (
            "#6P#04504FWe're pulling out!\x02\x03",
            "#04512F報酬も入ることだし、\x01",
            "今夜はパーッと行くか。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "#00000F戦術書――\x01",
            "これはティオとワジが扱えYeah we should\x02",
        )
    )
