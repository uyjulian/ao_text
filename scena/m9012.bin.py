...
def main():
    ...
    AnonymousTalk(
        0xA,
        (
            "#3789V#40W#30AうEheようこそ。\x02\x03",
            "#3790V#40A世界の最果てにして\x01",
            "全ての因果律の中心へ。\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        (
            "#00214F#2694V#11P#N#30W#25Aよかった……\x01",
            "無事でしたか……\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00307F#2774V#5P#N#30W#20Aキー坊、大丈夫なのか!?\x02",
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xD),
            "#12313F#3645V#5P#40A#50W………黙っていて……#800W…\x01",
    ...
    ChrTalk(
        0xA,
        (
            "#10809F#5PうEhe恐いですわね。\x02\x03",
            "#10800F#5Pですがわたくし達は\x01",
            "最大限にキーアさんの意志を\x01",
            "尊重していますわ。\x02\x03",
            "#10811Fそうですわよね──キーアさHuh?\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "全てロイドさんたちのため#24R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵#だって。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#02201F『世界を紡ぐ』──\x01",
            "すなわち因果律を操作し#22R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵#、\x01",
            "世界を組み替える#16R噵　噵　噵　噵　噵　噵　噵　噵#力というわけだ。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#10811F──貴方たちだって一度#18R噵　噵　噵　噵　噵　噵　噵　噵　噵#、\x01",
            "それに助けられています#22R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵#のに。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#10811Fあなた方が、暴走したヨアヒムに#18R噵　噵　噵　噵　噵　噵　噵　噵　噵#\x01",
            "殺されてしまった#16R噵　噵　噵　噵　噵　噵　噵　噵#という現実の改変が。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xD),
            "#12306F#11P#30W最初の時#8R噵　噵　噵　噵#……ロイドたちは\x01",
            "エステルたちやレンって子と\x01",
            "そんなに仲良くならなかった……\x02",
        )
    )
    ...
    ChrTalk(
        0x106,
        "#10708F#13PSo that happened…\x02",
    )
    ...
    ChrTalk(
        0x10A,
        "#00610F#13PSo that happened…\x02",
    )
    ...
    ChrTalk(
        0xA,
        (
            "#10802F#5P#30WうEhe素敵でしょう？\x02\x03",
            "#10809Fこんな素敵なもの#10R噵　噵　噵　噵　噵#があれば\x01",
            "もう何も恐くない…!\x02\x03",
            "世界の全てに幸福を与え、\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00001F#6P#N先生は──\x01",
            "本当にそれでいいんですか#24R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵#？\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "結果に繋がったとしても……\x02\x03",
            "#00013Fそれを無かったことにする#24R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵#のは\x01",
    ...
    ChrTalk(
        0x106,
        (
            "#10708F#13P#30W……That's true\x01",
            "人は時には間違いを\x01",
            "犯してしまう存在……\x02",
        )
    )
    ...
    ChrTalk(
        0xA,
        (
            "#10804F#5Pうふふ、使えない道具#4R噵　噵#を\x01",
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xD),
            "#12311F#3646V#5P#50W#18A……うぁぁUh!?\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#10407F#13P#30W#25A#N最高位の魔導師#6Rマ ギ ウ ス#と認定…!\x01",
            "全力で制圧する!\x02",
        )
    )
    ...
    ChrTalk(
        0x106,
        (
            "#10707F#13P#30W#25A#N漆黒の法力#4Rほうりき#を感知…!\x01",
            "全力で調伏します!\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        (
            "#10107F#13P#30W#25A#N危険度Ｓと推定…!\x01",
            "全火力をもって迎撃します!\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00106F#5PBelle…ここまでにして!\x02\x03",
            "#00101Fもうこれ以上、\x01",
            "私たちが戦う意味なんてないわ!\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#10811F──貴女の力によって#16R噵　噵　噵　噵　噵　噵　噵　噵#。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#10811Fその異常#4R噵　噵#さを、誰一人として\x01",
            "疑問に思わなかったのではなくて？\x02",
        )
    )
    ...
    ChrTalk(
        0xA,
        "#10803F#11P#30W#15Aいいえ──違いません。\x02",
    )
    ...
    ChrTalk(
        0xA,
        (
            "#10801F#11P#40W#30A貴女には無意識のうちに\x01",
            "周りの人間の心と魂を掴む力がある。\x02\x03",
            "#10804F#40W#30A誰もが貴女を愛し、守るよう、\x01",
            "因果と認識を操作してしまう力が。\x02\x03",
            "#10811F#40W#30AHaha紛いものの存在に\x01",
            "紛いものの愛というわけですわね？\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xD),
            "#12311F#3648V#11P#N#4S#20A#80WいやあああああAhh!──ッ!\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        "#10110F#13P#40W#20A……こ、この光って………\x02",
    )
    ...
    ChrTalk(
        0xA,
        (
            "#10804F#3796V#6P#N#40W#82Aクク、これぞ《零の至宝》と\x01",
            "《碧の大樹》が完全に一体化した\x01",
            "終わりにして始まりの形態……\x02\x03",
            "#3797V#80A全ての時空間の因果を操り、\x01",
            "女神の課した“枷”をも打ち破る\x01",
            "真にして偽なる地上の神…!\x02\x03",
            "#10811F#3798V#35A《碧の虚 神#5Rデミウルゴス#》ですわ!\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00010F#3332V#6P#N#30W#25Aそんな御託、知ったことか!\x02\x03",
    ...
    ChrTalk(
        0x104,
        (
            "#00307F#2775V#6P#N#30W#32Aおお、難しい話なんてのは\x01",
            "それからでも遅くはねぇだろ!\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        (
            "#00207F#2695V#12P#N#30W#40A──巨大な霊子体の顕現を確認!\x01",
            "中枢のコア部分にキーアがいます!\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00015F#3334V#6P#N#30AみんAh!\x01",
            "これが最後の戦いだ…!\x02\x03",
            "#00007F#3335V#50A全身全霊、俺たちの全てを\x01",
            "あの碧き存在にぶつけるぞ!\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00015F#5P#60W#25A俺が……必ずこの子を……\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00107F#3409V#6P#4S#N#15A#30Wロイド──!\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#00307F#2776V#6P#4S#N#15A#30Wロイドぉおおお!\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#10107F#3531V#6P#4S#N#15A#30Wロイドさん──!\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#00316F#12P#30W#20ALloyd…キー坊…!\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00116F#11P#30W#20A戻って……来てくれた……\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00116F#6P#30W#20ALloyd…キーアちゃん…!\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00216F#11P#30W#20A戻って……来てくれた……\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00216F#6P#30W#20ALloyd…キーア…!\x02",
    )
    ...
    ChrTalk(
        0x105,
        "#10411F#11P#30W#20AHah戻ってきたか……\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#10116F#11P#30W#20A戻って……来てくれた……\x02",
    )
    ...
    ChrTalk(
        0x106,
        "#10716F#11P#30W#20A戻って……来てくれた……\x02",
    )
    ...
    ChrTalk(
        0x10A,
        (
            "#00604F#13P#30W#20AまSeriously…\x01",
            "兄顔負けの無鉄砲さだ……\x02",
        )
    )
    ...
    ChrTalk(
        0xA,
        (
            "#10803F#3799V#5P#N#40W#35A──まったく。\x01",
            "つまらない幕引きですわね。\x02",
        )
    )
    ...
    ChrTalk(
        0x106,
        "#10709F#13PふふRight, that's true\x02",
    )
    ...
    ChrTalk(
        0x9,
        (
            "#05821F#3655V#5P#40W#40Aキーアも……\x01",
            "……キーアもがんばる…!\x02\x03",
            "#05819F#3656V#40Aみんなといっしょに……\x01",
            "……大切な場所を守るために!\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00009F#3337V#11P#30Aああ、一緒に頑張ろう。\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#3338V#11P#30W#30A──特務支援課、撤収。\x02\x03",
