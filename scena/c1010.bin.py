...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#00103FRed ConstellationやHeiyueの\x01",
            "出方が分からない以上、\x01",
            "油断は禁物ですけど……\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#00103FThat's trueそれは言えてますね。\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00012FHaha…お手柔らかにPlease do\x02",
    )
    ...
    ChrTalk(
        0xB,
        "キリカさん、Thanks for your hard work!\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00012F（Haha…この人も相変わらずRight.）\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00000FYes…That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#04000FYeah I know.どこだったかしら。\x02\x03",
            "エオリアのほうにも\x01",
            "あたってみたほうがいいかしらね。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00000FThat's fine, thank you\x01",
            "こちらこそ、アリオスさんたちの\x01",
            "協力があって助かりました。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00003Fやはり、Is that right\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#11P#00100Fふふ、ご忠告That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#5P#04003FI see..\x02\x03",
            "#04001F今回のマインツの占領事件……\x01",
            "Red Constellationが絡んでいる以上、\x01",
            "どこか予想はしていたけど。\x02",
        )
    )
    ...
    ChrTalk(
        0x10A,
        (
            "#12P#00603FHmm.大統領側が上手く\x01",
            "コントロールしているようRight.\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#6P#00103FYeah I know.この状態が長く続けば、\x01",
            "巻き込まれて怪我したりする人が\x01",
            "出ないとも限らないし。\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        (
            "#12P#00204FThat's fine, thank you\x01",
            "……とても心強いです。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00005FOh that's true.\x02\x03",
            "#00008F（そろそろ夕方だし……\x01",
            "  他にやっておく事はあったかな？）\x02",
        )
    )
    ...
    Menu(
        ...
        (
            "\x01",          # 0
            "Choice 2: Wait for Arios to return\x01",      # 1
        )
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00102FOk then we'll head up\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "HeiyueやRed Constellationについての\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "#04000FThank you, that really helps\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00004FNot at all, we're happy to be useful\x02",
    )
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10306FしかしRed Constellationの情報は\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "Red Constellationは別格といえるわね。\x02\x03",
            "大陸全土にコネクションを持ち、\x01",
            "紛争の兆しあらば即座に介入して\x01",
            "自分たちを高く売り込Hmm\x02\x03",
    ...
    ChrTalk(
        0x10,
        "#5P#01405FHmm. So there's a lot going on\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "活動を休止しているそうBut…\x02\x03",
            "Red Constellationの方は相変わらず\x01",
            "精力的に活動しているみたいね？\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        (
            "#00306FThat leaves my uncle\x02\x03",
            "#00303F──赤い星座の副団長、\x01",
    ...
    ChrTalk(
        0x10,
        (
            "#5P#01400FThose 3 are particularly famous\x02\x03",
            "#01403F──話を聞く限りでは、\x01",
            "俺ですら太刀打ちできるかどうか。\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00101FWhat kind of info?\x02",
    )
    ...
    ChrTalk(
        0x10,
        (
            "#5P#01403FOh, it's about Heiyue\x02\x03",
    ...
    ChrTalk(
        0x102,
        (
            "#12P#00108FHeiyueの長老というと\x01",
            "シン君のおじいさまもYeah I know.\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00006FOh is that right\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#04003FOf course, we can think of that possibility\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "仮にHeiyueやRed Constellationが動けば\x01",
            "そうした背景が明るみに出て\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00001FWe have to grab all the ones we can get\x02",
        )
    )
    ...
    ChrTalk(
        0x10,
        (
            "#5P#01404FActually, I was thinking the same\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#12P#00002FOh is that right\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#12P#10108FYes, it is worrying\x02",
    )
    ...
    ChrTalk(
        0x103,
        (
            "#12P#00204FAt least we can try it\x02\x03",
            "#00202Fこの機能については\x01",
            "ロバーツ主任が詳しいので\x01",
            "ＩＢＣに行ってみましょう。\x02\x03",
            "He will probably help us out\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#04001FBut is it really ok?\x02\x03",
            "１時間もすればアリオスたちが\x01",
            "戻ってくると思うんBut…\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00108FOh is that right\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#12P#00301FSo that's how it happened…\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00006FThe Commander of the Defense Army\x02\x03",
            "いきなりChoice 1: Acceptには\x01",
            "あまりに重過ぎる役目だと思います。\x02\x03",
            "#00001F多分、ディーター市長……\x01",
            "いや大統領との間で根回しが\x01",
            "されていたんじゃないですか？\x02\x03",
            "それも最近#4R噵　噵#ではなく、しばらく前#10R噵　噵　噵　噵　噵#から。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "スケジュールの食い違い──\x02\x03",
            "#00013F半年以上前#10R噵　噵　噵　噵　噵#で\x01",
            "覚えはありませんか？\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "そこまで前だとさすがに\x01",
            "覚えてないんBut…\x02\x03",
            "#04005FOh, but that happened\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#5P#04004FDuring the last day of the Anniversary Festival\x02\x03",
            "#04000F彼、仕事でレミフェリアに\x01",
            "出張する事になってたんBut…\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "忙しくて報告し損なってたって\x01",
            "言ってたけど……\x02\x03",
            "#04001FWhat? Is something concerning?\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#6P#00108FThe last day of the anniversary festival…\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#00301F#12PSo how is that connected?\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x0),
            "#00006FI don't need your useless babbling\x02\x03",
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "Aww, I'm not very well liked\x02\x03",
            "派手な事になってるみたいだが\x01",
            "ちょっと会って話せないか？\x02\x03",
            "Well, it's your loss if you don't\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "いや元《ルバーチェ商会》と\x01",
            "言った方がいいか。\x02\x03",
            "I'll be waiting in the head office\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#5P#00003FNo it's not him\x02\x03",
            "#00013FIt's Secretary Lechter of the Empire\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "話があるみたいだ。\x02\x03",
            "#00001FRed Constellationとの繋がりを考えると\x01",
            "とても油断はできないけど……\x01",
            "行くだけ行ってみよう。\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        "#5P#04006FYou guys have it hard too\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00102FThat's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#04004F#5Pあら、お前とは随分な言い方ねHuh\x02\x03",
