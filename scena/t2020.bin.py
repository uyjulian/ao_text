...
def main():
    ...
    ChrTalk(
        0x104,
        "#00309Fはは、その意気なら大丈夫Yeah we should\x02",
    )
    ...
    ChrTalk(
        0xA,
        (
            "#10604F#5Pふふ、Yeah I know.\x02\x03",
            "どの程度かによるけど\x01",
            "事の真偽がはっきりするまで\x01",
            "“慎重に状況を見極める”……\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#5PあAh...\x02\x03",
            "こういう事はエリィの判断が\x01",
            "一番頼りになりそうBut…\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "確かRed Constellationの部隊……\x02\x03",
            "#10601F国防軍の部隊は\x01",
            "常駐していなかったわね？\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#12P#10304Fふうん、帝国商人の出迎えねHuh\x02\x03",
            "#10302Fさしずめ、例の\x01",
            "『クリムゾン商会』とやらの\x01",
            "関係者か何かってトコかな？\x02",
        )
