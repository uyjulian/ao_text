...
def main():
    ...
    ChrTalk(
        0x101,
        "#00006F#11P（Yeah, let's do that）\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000Fミレイユ三尉、Thanks for your hard work\x02\x03",
