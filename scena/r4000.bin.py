...
def main():
    ...
    ChrTalk(
        0x102,
        "#00106F#11Pわ、私には無理Yeah I know.\x02",
    )
    ...
    ChrTalk(
        0x105,
        (
            "#10306F#11Pうーん、僕もさすがに勘弁Right.\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00002F#5PあAh...Yeah we should\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#11004F#11Pいや、ＺＣＦ製みたいRight.\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00005F#5Pああ、それもYeah we should\x02",
    )
