...
def main():
    ...
    AnonymousTalk(
        ...
        (
            ...
            "──手筈の通り、\x01",
            "“人形”はオレらがChoice 1: Accept。\x02\x03",
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "Lloyd, go with Aidos\x02\x03",
            "それとエリィさんのこと、\x01",
            "どうかPlease do\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x107,
        (
            "#01203F#11P#3CThat is indeed the pact from ancient times\x02\x03",
    ...
    ChrTalk(
        0x106,
        (
            "#10709F#12PあHaha…ごめんなさい。\x02\x03",
    ...
    ChrTalk(
        0xF,
        (
            "#02105F#5Pあら、Could it be…\x02\x03",
            "みんなでビーチで\x01",
            "遊びに行った事があるとか？\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "次の目的地は決まった。\x02\x03",
            "#00008FRed Constellationの部隊が\x01",
            "警備しているらしいが……\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00000F#11P──いえ、Please do\x02\x03",
    ...
    ChrTalk(
        0x8,
        (
            "#12100F#5PWe are directly above the booster site\x02\x03",
            "We can start anytime\x02",
        )
    )
    ...
    ChrTalk(
        0xF,
        (
            "#02109F#11POk ok!\x02\x03",
            "#02100FChairman, all set?\x02",
        )
    )
    ...
    ChrTalk(
        0x9,
        (
            "#02304F#11PHehe, well here we go!\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#10401Fまるで人の身では勝てない事が#22R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵#\x01",
            "決まっている#12R噵　噵　噵　噵　噵　噵#かのような強さだ。\x02",
        )
    )
    ...
    NpcTalk(
        0x1A,
        "守護騎士ケビン",
        "#04303F#11P#3C#40W#19AUnlock the power of the shining stamp in my soul\x02",
    )
    ...
    NpcTalk(
        0x1A,
        "守護騎士ケビン",
        "#04303F#11P#3C#40W#21ALight from the heavens gather around me\x02",
    )
    ...
    NpcTalk(
        0x1A,
        "守護騎士ケビン",
        "#04307F#11P#4S#15A《聖痕砲》メギデルス──展開!\x02",
    )
    ...
    ChrTalk(
        0x103,
        (
            "#00201F#12P#NRed Constellationが運用している\x01",
            "強襲揚陸艦ですか……\x02",
        )
    )
