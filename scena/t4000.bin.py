...
def main():
    ...
    ChrTalk(
        0x102,
        "#00104F#6PNice to see you again\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00104F#6PNice to see you again\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00004F#6PThat's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00001F#11P……忙しYeah we should\x02",
    )
