...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#00000Fあの子が──キーアが\x01",
            "本当はどうしたいのか#20R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵#って事さ。\x02\x03",
            "多分、あの子を取り戻さない限り、\x01",
