...
def main():
    ...
    ChrTalk(
        ...
        (
            "#6P#00000FYes.\x01",
            "雨の中Thanks for your hard work\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00006F……すみません、Please do\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "メイリンに傘を渡し、\x01",
            "モモの傘Got FORCE from Dudley\x07\x00\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "メイリンに傘を渡し、\x01",
            "モモの傘Got Access Card\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        (
            "#6P#10101FHeiyue Trading company…\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#10300FDo you want to talk to him\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        "#5P#10100F(Yeah, tha's for sure)\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#6P#00006F(What in the hell)\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00106Fと、とにかくLet's go after him!\x02",
    )
