...
def main():
    ...
    ChrTalk(
        0x104,
        "#00310F#12PNo way it couldn't be…\x02",
    )
    ...
    ChrTalk(
        0x105,
        "#10307F#2914V#6P#4S#10A来る──下がれ!\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x2),
            "#3574V#40W#4S#18A………カハハハハハハッ………\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#10306F#12P#NあAh...そうだね。\x02\x03",
            "#10308F君のファッションの\x01",
            "悪趣味さは知っていたけど……\x02\x03",
            "#10310Fさすがにそれ#4R噵　噵#は、幾らなんでも\x01",
            "やりすぎなんじゃないの.......?\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00010F#4P#NW-wait a minute\x02",
    )
