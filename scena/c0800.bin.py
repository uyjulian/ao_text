...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00004FYeah, I'm fine\x02\x03",
    ...
    ChrTalk(
        0xA,
        "#01109F#5PWelcome home, Lloyd!\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#12P#10111F#3513V#30WOh,… Fran!\x02",
    )
    ...
    ChrTalk(
        0x109,
        (
            "#12P#10102FNope, I'm totally fine\x02\x03",
    ...
    ChrTalk(
        0xA,
        "#5P#01101FRight right, exactly!\x02",
    )
    ...
    AnonymousTalk(
        0x102,
        (
            "#3387V#30WYeah, just yesterday\x02\x03",
    ...
    ChrTalk(
        0x109,
        (
            "#12P#10109FThanks for your hard work Elie\x02\x03",
            "#10100Fたしかマクダエル議長の付き合いで\x01",
            "各国を回ってたんですよね？\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        (
            "#12P#10103FYes! Noel Seeker!\x02\x03",
    ...
    ChrTalk(
        0x105,
        (
            "#10304F#2905V#5P#30WHehe, good work all\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#10309F#5PHeh, set a thief to catch a theif.\x02",
    )
    ...
    ChrTalk(
        0x105,
        (
            "#5P#10309FAhah, that's a silly question\x02\x03",
            "君の反応が面白いからに\x01",
            "決まってるじゃないか。\x02",
        )
    )
    ...
    ChrTalk(
        0xB,
        (
            "#6P#01906FMust be nice to be in the SSS…\x02\x03",
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x0),
            "#10103FThat's true\x01",
            "まさに威風堂々という感じTrue.\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00003FYeah I was thinking that too\x02",
    )
    ...
    ChrTalk(
        0x20,
        "Oh right you guys have experience right?\x02",
    )
    ...
    ChrTalk(
        0x20,
        "How about by rock paper scissors\x02",
    )
    ...
    ChrTalk(
        0x20,
        "Do it a few times to decide the teams\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#00300FI guess me and Noel won \x02",
    )
    ...
    ChrTalk(
        0x20,
        "Hmm. Sounds like you figured it out then\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00000FOk how should we split up?\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00100FBut why was he on the train then?\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00200FYes we just saw one case\x02",
    )
