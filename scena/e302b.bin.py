...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#00000Fまあ、その調子なら\x01",
            "ここは任せてよさYeah we should\x02\x03",
            "ティオたちもしっかり\x01",
            "休息をとっておいてくれよ？\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004FYes, see you then\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00006Fあ、ああI see…\x02\x03",
            "#00000Fまあ、アッバスがそう言うなら\x01",
            "今回は信じてよさYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "言っておいた方がよさYeah we should\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00009Fはは、Yeah we should\x02\x03",
            "#00005Fそれにしても……\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00306F……でも、Yeah we should\x02\x03",
            "#00308Fそろそろ……話しても\x01",
            "いい頃合いかもしれねHuh\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00000FYes, see you then\x02\x03",
    ...
    ChrTalk(
        0xA,
        "#11P#10409FWell then it's decided\x02",
    )
    ...
    ChrTalk(
        ...
        (
            "#00004F#12P……十分です。\x01",
            "You've helped us out so much\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "Well then excuse me\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#12PYeah, we know\x02\x03",
            "#00013F……何とか入り込んで\x01",
            "課長やダドリーさんたちと\x01",
            "合流しないとな。\x02",
        )
