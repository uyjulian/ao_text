...
def main():
    ...
    ChrTalk(
        0x103,
        "#00202F……どうも、Nice to see you again\x02",
    )
    ...
    ChrTalk(
        0x15,
        (
            "#01303F#5P私たちの住むクロスBelle…\x02\x03",
            "#01308F過去に色々な経緯があって\x01",
            "今があるという事はGot it\x02\x03",
    ...
    ChrTalk(
        0x15,
        (
            "#01306F#5PYeah I know.４人をキーアちゃんに\x01",
    ...
    ChrTalk(
        0x101,
        "#00000F#12PYeah, let's do that\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#5P#10105FAha, is that right\x02",
    )
