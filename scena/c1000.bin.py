...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#00306FBut she's also quite troublesome\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "The Government of the Calvard Republic\x02\x03",
            "狡猾な犯罪組織と手を結んでいた\x01",
            "彼らもまた、クロスベルの平和と\x01",
    ...
    ChrTalk(
        0x101,
        "#6P#00001FIt's no good… we lost him\x02",
    )
    ...
    ChrTalk(
        0x109,
        (
            "#12P#10106FW-what a crazy person…\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#5P#00105FI wonder what's going on there\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00000FLet's head to the Jazz Bar\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00100FThanks for your help\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#11P#00105FThat's good but\x02\x03",
    ...
    NpcTalk(
        0x1C,
        "少女の声",
        "#3949VHuh? What are you doing there\x02",
    )
    ...
    ChrTalk(
        0x1C,
        (
            "#04606FOh that's cold\x02\x03",
            "#04600Fそれじゃあ、そっちのお姉さんの\x01",
            "身体に聞いちゃおうかな？\x02\x03",
            "#04609Fまた思いっきり揉んでみたいし噴\x02",
        )
    )
    ...
    ChrTalk(
        0x1C,
        "#04609FAhaha, that's no good\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00006Fど、What do you mean?\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#04604FSo then there's only one answer\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "#00105Fそうか、どうして\x01",
            "気付かなかったのかしら。\x02\x03",
            "#00100FThe residential district\x02",
        )
    )
    ...
    ChrTalk(
        0x1C,
        (
            "#04609FAhah, exactly\x02\x03",
            "#04602FWell then Ill head there first\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#12P#10304FEheh, seems like it\x02\x03",
    ...
    ChrTalk(
        0x109,
        "#6P#10106FIt's not a laughing matter\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "変わらないものTrue.長く音信普通だったことも忘れ\x01",
    ...
    AnonymousTalk(
        ...
        (
            ...
            "本当に、いつもThat's fine, thank you\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "#00100F本当に心優しくて\x01",
            "不思議な人だったわね。\x02\x03",
            "#00103F（That's right..お祖父様の１つ上の世代に\x01",
            "  伝説の『社交界の華』と呼ばれる\x01",
            "  素敵な女性がいたそうBut…）\x02\x03",
            "（……ま、まさかね。）\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000Fこの先は東クロスベル街道Right.\x02\x03",
            "特に用事はないし、\x01",
            "出るのは止めておこう。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00001Fこの先は東クロスベル街道Right.\x02\x03",
            "今は寄り道せずに、\x01",
            "事故関連の捜査に集中しよう。\x02",
        )
    )
