...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "現れたわけじゃあるまい。\x02\x03",
            "#01003F確かにRed Constellationの動向は\x01",
            "気になるが、そればかりに\x01",
    ...
    ChrTalk(
        0x8,
        (
            "#01003FIm here on standby for today\x02\x03",
    ...
    ChrTalk(
        0x9,
        (
            "#01100Fみんな、See you later!\x02\x03",
    ...
    ChrTalk(
        0x9,
        (
            "#01109Fみんな、See you later!\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#12P#00100FYeah, I'll give it a shot\x02",
    )
    ...
    ChrTalk(
        0x105,
        "#12P#10302FWoah, you're pretty good at that\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#5P#00002FBut it really helps us out\x02\x03",
    ...
    ChrTalk(
        0x102,
        (
            "#12P#00109FRight, no problem\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#5P#00000FYeah let's do that\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00100FOk then you can sit here\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "Oh it was perfect\x02\x03",
            "市内でやる分には\x01",
            "目立ったラグもないし、\x01",
            "通信状態も良好だ。\x02\x03",
            "I would say it was a great success\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#12P#00100FEhe, nice work\x02\x03",
            "#00104Fなんていうか、\x01",
            "主任らしい依頼だったわね。\x02",
        )
    )
    ...
    AnonymousTalk(
        0x109,
        "#10105FThe Investigator's Notebook…\x02",
    )
    ...
    AnonymousTalk(
        0x105,
        (
            "#10305FHmm. It's quite convinient then\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#12P#10309FHehe, I'm interested to take a look.\x02",
    )
    ...
    AnonymousTalk(
        0x109,
        "#10108FSo he must be full of information\x02",
    )
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10304FAlthough he was more than half just an ordinary guy\x02\x03",
    ...
    ChrTalk(
        0x102,
        (
            "#00108F#11PHe said that himself\x02\x03",
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10309FWell it seems interesting\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00003FA few months after the Ruvache ordeal\x02\x03",
    ...
    AnonymousTalk(
        0x102,
        (
            "#00104FMayor Dieter Crois\x02\x03",
            "彼が主催する、帝国、共和国、\x01",
            "リベール、レミフェリアの首脳が\x01",
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10304FYeah, when he gave me the letter of recommendation\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#5P#00006FI don't think it's a bad thing though\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#01003F#5PYeah, as you were.\x02\x03",
    ...
    ChrTalk(
        0x8,
        (
            "#01004F#5PHah… seems you get it\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#00105F#11PAn order from you?\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00100F#11PBut what do you need from there?\x02",
    )
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10304FHah, smooth words\x02\x03",
            "#10302Fで？\x01",
            "さっそく街に出るのかい？\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "小雨が降り続くみたいRight.\x02\x03",
            "#01000FTonight is going to be pretty stormy\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00005F#11PAshley in the information broker office\x02\x03",
    ...
    ChrTalk(
        0x8,
        (
            "#01004F#5PWell, do your best\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00002F#5PYeah, let's do that\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00002F#5PYeah. Let's go meet him\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "両部門を引き継ぐ人物……\x02\x03",
            "#00301FWell, we have to keep an eye on them\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#6P#00309FOh I might have said something\x02",
    )
    ...
    ChrTalk(
        0x109,
        (
            "#6P#10112F(Sounds like a bulls eye)\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#00109F#11PYep. Let's do that\x02",
    )
    ...
    ChrTalk(
        0x105,
        (
            "#11P#10302F──Red Constellationって連中の\x01",
            "動向なんかも探りながら。\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#11P#10303FIt's not like they're mallicious\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#5PWell that's all the more reason\x02\x03",
            "#00008F確かにRed Constellationというのは\x01",
    ...
    ChrTalk(
        0x109,
        (
            "#5P#10101FB-but I agree!\x02\x03",
            "こういう時に力を合わせるのが\x01",
            "特務支援課なんですよね!?\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "Randy, it should be the same this time\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#5PYeah, definitely \x02\x03",
    ...
    ChrTalk(
        0x102,
        (
            "#00104F#11PYeah, it's been a while\x02\x03",
    ...
    NpcTalk(
        0x105,
        "ワジの声",
        "#1P#2SHuh? What are you doing?\x02",
    )
    ...
    NpcTalk(
        0x102,
        "エリィの声",
        "#1P#2SDid you guys forget something?\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "昼食会に各種懇談#4Rこんだん#会って所Right.\x02\x03",
    ...
    ChrTalk(
        0x8,
        (
            "#5P#01004FThat should be fine\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#5P#00005FへOh is that right?\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00102FNot exactly a hobby.\x02\x03",
    ...
    ChrTalk(
        0x109,
        "#5P#10101FPlease show those to me!\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00002FOh KeA, Zeit. Welcome home\x02",
    )
    ...
    ChrTalk(
        0x9,
        (
            "#01104F#5PAh, no, nothing\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00000FYeah. We won't return till evening I think\x02\x03",
            "How about you, Director\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#5P#01003FIm here on standby for today\x02\x03",
    ...
    ChrTalk(
        0x109,
        (
            "#6P#10104FYeah, it could be a good opportunity\x02\x03",
    ...
    ChrTalk(
        0x102,
        (
            "#00104F#11PRight. I agree.\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00009FYeah, for a bit of a break\x02\x03",
            "#00000Fそれにしても……\x01",
            "マフィンを焼いてたのか？\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        (
            "#00301F……Red Constellationの方に\x01",
            "相変わらず動きはないんスか？\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "Red Constellationだけじゃない。\x02\x03",
    ...
    ChrTalk(
        0x9,
        "#6P#01105FYou guys are leaving again?\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#11PYeah, we're busy at work today\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#5PWait a second\x02\x03",
            "#00013Fいくらランディでも\x01",
            "キーアの父親役は譲れないぞ？\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        "#10309FStop trying to be parents\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x0),
            "#01110F#3607V#30WUh, hello?\x02\x03",
    ...
    ChrTalk(
        0x102,
        (
            "#12P#00109FEhe, that's right\x02\x03",
            "#00102Fやっぱり端末前には\x01",
            "ティオちゃんがいる方が\x01",
            "しっくりくる感じだし。\x02",
        )
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00004FあAh...Yeah we should\x02\x03",
            "#00002F──とにかくティオ。\x01",
    ...
    ChrTalk(
        0x109,
        "#12P#10101FWe'll count on you!\x02",
    )
    ...
    ChrTalk(
        0x8,
        "#01002F#5PYeah. Ok then I'm heading out\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00100FShe said she'll be home by noon\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00106F#11P……Yeah I know.\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#10302F#12PCrisis management, as it's called, right\x02",
    )
    ...
    ChrTalk(
        0x105,
        "#10305F#12PDid you realize something?\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#6P#10101FThere might be a connection to the Organization\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "何か用件ができたら\x01",
            "改めて訪ねてくるがいい。\x02\x03",
            "Anything about Renne I can discuss\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "あるかもしれませんね。\x02\x03",
            "#00201FIt might be a bit dangerous\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000F#11PYes. Let's go check it out\x02\x03",
    ...
    ChrTalk(
        0x9,
        (
            "#6P#01105F#6PHey hey guys\x02\x03",
            "Are you heading to work already\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00309F#11PHaha, we'll if it's KeA it makes sense\x02",
    )
    ...
    ChrTalk(
        0x9,
        (
            "#6P#01103FYeah, I think I'll be fine\x02\x03",
    ...
    ChrTalk(
        0x104,
        "#00305F#11POh the real deal!\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00004F#11POh, that was delicious\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#12P#10109FThanks a lot KeA-chan\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#6P#00202FIt was really yummy\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#01110FWazy, are you full now?\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#5P#01004FHmm. Looks like you regained conscienceness a bit\x02\x03",
            "#01000Fヴァルド・ヴァレスの件だが……\x01",
            "警備隊方面で捜索は続けられている。\x02\x03",
            "Don't get so caught up in it\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#01000FSo don't get too worried\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#6P#00100FYep. Let's do that\x02",
    )
    ...
    ChrTalk(
        0x9,
        "#6P#01105FThere's a phone call\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00000F#11PYeah, I'll get it\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x0),
            "#00006FI see…\x02\x03",
            "#00005FIs that why you called\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        "#6P#00211FNo one cares about that\x02",
    )
    ...
    ChrTalk(
        0x109,
        (
            "#12P#10106F#NBut it's kind of worrying\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#01002FIt's important to work together in times like this\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "#6P#01105Fロイドたち、\x01",
            "もう出かけるのー？\x02\x03",
            "#01102FIs nabe ok today too?\x02",
        )
    )
    ...
    AnonymousTalk(
        0x8,
        "#01003FI see… you're going back\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#5P#00106FThat's understandable…\x02\x03",
            "#00108F今回の件で警備隊も\x01",
            "かなりの損害を負ったみただし。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "遊びに来ちゃうから…!\x02\x03",
            "#10100F#30WAlong with Fran…\x02\x01",
            "#10108F#45W.............…\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        "#10102F#11PLet's work well together, everyone!\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "I'll be treating this time\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#6P#00002FHaha, that's great\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00202F#11PThat's very generous\x02",
    )
    ...
    ChrTalk(
        0x104,
        (
            "#5P#00305FOh that's not bad!\x02\x03",
    ...
    ChrTalk(
        0x9,
        "#01105F#5PThere's a place like that?\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00108F#11PThere's a lot of them, like we thought\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00102F#11PYeah I know.いいと思うわ。\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#5PNoel, don't hold back\x02\x03",
    ...
    ChrTalk(
        0x102,
        (
            "#5P#00103FThat's understandable…\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00200FRight after the director left\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#00105FCould it be related to Arios?\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "それも──#350W─\x01",
            "#20Wあの、アリオスさんに#20R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵#。\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00108FWhat did the director say?\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "Lloyd told them about what Sergei had explained\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0xB,
        (
            "#05923F#5PえUh…私にはそう見えたわ。\x02\x03",
            "#05921Fでも、あなたたちに\x01",
            "無断でというのも変だったから\x01",
            "止めようとしたんBut…\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#5P#00008F……What do you mean?\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#12P#00201FLet's chase them, Lloyd!\x02",
    )
    ...
    ChrTalk(
        0xB,
        (
            "#05923F#5PYes, take care\x02\x03",
            "#05928F……アリオスさんもキーアちゃんも\x01",
            "いつになく真剣な目をしていたわ。\x02\x03",
            "#05921FI think there's a big situation developing\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "#20A#30W──よし。\x01",
            "それじゃあ鍋を始めよう。\x02\x03",
            "#20A#30Wキーアが準備してくれたから\x01",
            "肉、魚、野菜──タップリある。\x02\x03",
            "#20A#30Wたくさん食べて、早めに休んで……\x01",
            "明日に備えよう!\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00000FYeah, let's do that\x02",
    )
