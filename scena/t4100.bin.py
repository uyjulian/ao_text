...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00004FえUh…そのつもりです。\x01",
            "ご忠告That's fine, thank you\x02",
        )
    )
    ...
    ChrTalk(
        0x12,
        (
            "#5P#07003FAha, is that right\x02\x03",
    ...
    ChrTalk(
        0x12,
        "#11P#07002Fふふっ、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0xF,
        (
            "#11P#01404FOh, no, nothing.\x02\x03",
            "#01400F──用は済んだ。\x01",
    ...
    ChrTalk(
        0x101,
        "#6P#00000FAh...Thanks for your hard work\x02",
    )
