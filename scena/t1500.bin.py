...
def main():
    ...
    ChrTalk(
        0x101,
        "#00002F……That's fine, thank you\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "それもあるけど……\x01",
            "HeiyueとRed Constellationに関してね。\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        (
            "#00303F#11PHeiyueとRed Constellationか……\x02\x03",
            "#00301F確かにアリオスのオッサンなら\x01",
            "自治州外の情報にも詳しYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00104F#12PRed Constellationの情報は\x01",
            "一通り集められたけど……\x02\x03",
    ...
    ChrTalk(
        0x102,
        (
            "#00103F#12PRed Constellationの情報も\x01",
    ...
    ChrTalk(
        0x109,
        (
            "#10105F#6Pあ、Yeah…３０１だけど。\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00000F#11PGot it. Let's go\x02\x03",
            "#00003F（……セシル姉も相当、\x01",
            "  忙しくしてるんだろうな。）\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00309F#5Pハハ、それもYeah we should\x02",
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "#10401F#30W#5P#20A識#2Rしき#の銀耀と結び付きて、\x01",
            "偽りの記憶を彼らに与えよ。\x02",
        )
    )
    ...
    ChrTalk(
        0x107,
        "#01200F#2P#3C#6P#Nフム、無事のようRight.\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00213F#11P#2687V#50W#25A#2S……Lloyd…さん………\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00212F#2691V#60A……だ、脱走して\x01",
            "軍の人たちに追われてるって……\x01",
            "ど、導力ネットで、見かけて…!\x02\x03",
            "#00213F#2692V#50Aわ、わたし……ヒック……\x01",
            "………ずっと心配で…………!\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        "#00215F#11P#2693V#40W#25A……うUhぐすUh\x02",
    )
    ...
    ChrTalk(
        0x16,
        (
            "#11P#01300FEheお帰りなさい、ロイド。\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#6P#00100Fふふ、Nice to see you again\x02",
    )
    ...
    ChrTalk(
        0x109,
        (
            "#5P#10109Fふふっ、本当に久しぶりTrue.\x02\x03",
    ...
    ChrTalk(
        0x16,
        (
            "#11P#01305Fあら、見かけない子もいるみたいBut…\x02\x03",
