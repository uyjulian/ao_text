...
def main():
    ...
    ChrTalk(
        0x102,
        "#00109FEhe, thank you so much\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00202Fふふっ、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00109Fふふ、Thanks for your hard work\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "他の方と競うというのは、\x01",
            "違う気がしたもので……\x02\x03",
            "#04409Fですが、That's fine, thank you\x01",
            "お世辞でもうれしいです。\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#00109FEhe, that's right\x02\x03",
