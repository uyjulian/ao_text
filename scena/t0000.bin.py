...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#00301F……こいつは厄介Yeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#6P#00300Fハッ、やるしかなさYeah we should\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#6P#00000Fええ、その時は是非Please do\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000Fご協力That's fine, thank you\x01",
            "おかげで色々参考になりました。\x02",
        )
    )
