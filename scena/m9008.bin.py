...
def main():
    ...
    ChrTalk(
        0x102,
        (
            "#00106F#12P#30WえUh…私たち特務支援課の\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#5P#30WあAh...ジオフロントに潜って\x01",
            "リュウたちを助ける時に\x01",
            "危ない所を助けてもらって……\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        "#10100F#13POh is that right\x02",
    )
    ...
    ChrTalk(
        0x106,
        "#10710F#13POh is that right\x02",
    )
