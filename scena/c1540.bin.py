...
def main():
    ...
    ChrTalk(
        0x109,
        "#10100FどうもThat's fine, thank you\x02",
    )
    ...
    ChrTalk(
        ...
        (
            "特務支援課の皆さんTrue.\x01",
            "巡回のお仕事Thanks for your hard work\x02",
        )
    )
    ...
    ChrTalk(
        0x17,
        (
            "#11P#01404F６年前That's true…\x02\x03",
            "当時、あてもなく大陸中を\x01",
            "さすらっていたという君が\x01",
    ...
    ChrTalk(
        0xB,
        (
            "#12004F#6Pええ、それなりにRight.\x02\x03",
    ...
    ChrTalk(
        0x1D,
        (
            "#02803F#11P#30W……I see…分かった。\x02\x03",
