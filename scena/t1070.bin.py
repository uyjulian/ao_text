...
def main():
    ...
    ChrTalk(
        ...
        (
            "ホホホ……\x01",
            "お買い上げThat's fine, thank you\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        "#12P#10300F残念ながら、紹介状はないねHuh\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00005FYes, that's right\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00005FどれHmm…\x02\x03",
            "#00000Fうん、That's true\x01",
            "エリィに似合いそうな気がするよ。\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#6P#00112Fえ、Ah...\x02\x03",
            "#00112Fそ、そのUhち、違いますから!\x01",
            "私たちはまだそういうんじゃ…!\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "  ティオにぴったり似合いYeah we should）\x02\x03",
            "#00003F（値段は……１００００ミラか。\x01",
            "  結構するけど……）\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00012FHaha…いや、なんだか\x01",
            "ノエルらしい意見Right.\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00002Fはは、確かにノエルに似合いYeah we should\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "給料とは別の臨時収入#8R噵　噵　噵　噵#が多くなるかな。\x02\x03",
            "#10302Fセレブなマダムから\x01",
            "お小遣い代わりに宝石を渡される、\x01",
            "なんてことがたまにあるしね。\x02",
        )
    ...
    ChrTalk(
        0x105,
        (
            "#6P#10309FアHah, it's fine\x02\x03",
