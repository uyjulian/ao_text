...
def main():
    ...
    ChrTalk(
        0x105,
        "#10406F#12Pその可能性は高That's right…\x02",
    )
    ...
    AnonymousTalk(
        0xB,
        (
            "#3404V#40W#40Aよかった……\x01",
            "……本当によかった……\x02\x03",
            "#3405V#40A無事でいてくれて……\x01",
            "……こうしてまた会えて……\x02\x03",
            "#3406V#40Aもう二度と……\x01",
            "会えないかと思ったから……\x02",
        )
    ...
    ChrTalk(
        0x106,
        "#10706F#6P（こ、That's a problem）\x02",
    )
    ...
    ChrTalk(
        0x106,
        "#10710F#6PWell, it's a long story\x02",
    )
