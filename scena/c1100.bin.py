...
def main():
    ...
    ChrTalk(
        0x101,
        "#00000Fええ、Thanks for your hard work\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00200Fどうも、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#5P#00005FOh, from the director?\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00100FSo it was the director right?\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#5P#00000FYeah. Let's head to the West Exit\x02",
    )
