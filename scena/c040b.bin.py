...
def main():
    ...
    BuildStringList((
        ...
        "Central square",               # 26
        "Nishi dori",                 # 27
        "Administrative district",                 # 28
        "Residential area",                 # 29
        "Entertainment district",                 # 30
        "East Street",                 # 31
        "old Town",                 # 32
        "Harbor district",                 # 33
        "IBC",                 # 34
        "Beside the station",               # 35
        "Back street",                 # 36
        "Ursula interchange",           # 37
        "East Crossbell Highway",       # 38
        "West Crossbell Highway",       # 39
        "Mainz Mountain Road",           # 40
        "Orchis Tower",         # 41
    ))
