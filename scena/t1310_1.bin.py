...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#12510F#12PAh…ま、負けてたまるか!\x02\x03",
    ...
    ChrTalk(
        0x13,
        (
            "#12909F#12P#NAhah, sorry sorry\x02\x03",
            "#12900Fま、気を取り直して\x01",
            "なんとか逆転しようじゃないか。\x02",
        )
    )
