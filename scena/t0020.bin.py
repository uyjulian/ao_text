...
def main():
    ...
    ChrTalk(
        0x102,
        "#12P#00100FOk then let's go.\x02",
    )
    ...
    ChrTalk(
        ...
        (
            "#00003F（あAh...とにかく、\x01",
            "  そこそこの情報は\x01",
            "  得られたみたいRight.）\x02\x03",
            "#00000Fご協力、That's fine, thank you\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "#00000FI see..\x01",
            "色々と分かりました。\x02\x03",
            "#00004Fご協力、That's fine, thank you\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000Fええ、Nice to see you again\x02\x03",
            "最近、変わったことは\x01",
            "ありませんでしたか？\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#11P#00001F……Red Constellationが\x01",
            "アルモリカ村を訪れていたとはな。\x02",
        )
    )
    ...
    ChrTalk(
        0x16,
        "#03710F#11PAha, is that right心配True.\x02",
    )
    ...
    ChrTalk(
        0x15,
        (
            "#03609F#11PHaha…That's fine, thank you\x02\x03",
            "#03600Fまあ、そういうわけで\x01",
            "私も恩返しに村のお手伝いを\x01",
            "させて頂いてるんです。\x02\x03",
            "#03604Fとは言っても、時々訪れる\x01",
            "国防軍との交渉を\x01",
            "Choice 1: Acceptくらいなのですが。\x02",
        )
    )
