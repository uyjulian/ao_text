...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "何か用件ができたら\x01",
            "改めて訪ねてくるがいい。\x02\x03",
            "#03900FAnything about Renne I can discuss\x02",
        )
    )
    ...
    ChrTalk(
        0xB,
        (
            "#03900F#5PHumph. Well whatever\x02\x03",
            "#03903F……我が工房の技術、\x01",
            "お前たちの舞台に活かす方が\x01",
    ...
    ChrTalk(
        0x104,
        (
            "#00306F#12P……おいおい、What do you mean?\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00108FThe Phantom Flame plan…\x01",
            "そしてクロスベルを訪れるという\x01",
            "２人の《使徒》の存在……\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        (
            "#00206F#11PHmm \x02\x03",
            "#00201F先ほど案内してくれた\x01",
            "人形にしてもそうなのですが……\x02\x03",
            "《結社》というのはどうも、\x01",
            "遊び#4R噵　噵#が多い組織だと思いまして。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "Red Constellationクラスの猟兵団や\x01",
            "Heiyueみたいなシンジケートの方が\x01",
