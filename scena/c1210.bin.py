...
def main():
    ...
    ChrTalk(
        0x101,
        "#6P#00001FSorry to barge in\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#03204FSo you're back now huh\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#03204FThese guys will show you around?\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#11P#03200FHehe, let me introduce you\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#6P#10300FHah, what a request\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#6P#00105FWhy do you know that?\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00109FHehe, nice to meet you Shin\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#6P#00005F(W-what in the world)\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#11P#03204FHehe, well that's good to hear\x02\x03",
            "#03209F──それでは皆さん。\x01",
            "シン様をPlease do\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#11P#03200Fどうです、ロイドさHuh?\x02\x03",
            "シン様のクロスベル案内を\x01",
            "お願いしてもいいですか？\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#5P#00303FI guess that's fine\x02",
    )
    ...
    ChrTalk(
        0x105,
        "#11P#10300FWell then it's decided\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#03204FThat's fine, thank you\x01",
            "どうもお疲れさまでした。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "シン様との#10R噵  噵  噵  噵  噵#お近づきの印として\x01",
            "受け取っていただけませんか？\x02",
        )
    )
