...
def main():
    ...
    ChrTalk(
        0x8,
        (
            "#6P#04809FOh how pretty!\x02\x03",
            "金融都市クロスベルの象徴も\x01",
            "ああなっちゃ大きな松明#4Rたいまつ#だ。\x02\x03",
            "#04802FしかしRed Constellationか……\x02\x03",
            "ウチの強化猟兵程度じゃ\x01",
            "太刀打ちできなさそうだね。\x02",
        )
    )
    ...
    ChrTalk(
        0x9,
        (
            "#11P#04923F#30WHmm \x02\x03",
            "#04920FThis time it has been quite a heartless battle\x02\x03",
            "あの者たちはあの者たちの流儀で\x01",
    ...
    ChrTalk(
        0x9,
        "#11P#04923F#30WYeah, that's fine\x02",
    )
