...
def main():
    ...
    AnonymousTalk(
        ...
        (
            ...
            "Treasure hunting in an old dungeon\x02\x03",
            "たまにはああいう王道な趣向も\x01",
            "悪くなかっただろう？\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#04804F#11P#30W#30Aウフフ、ここは足場が悪いから\x01",
            "もう少し広い場所に案内するよ。\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#00108F#6P#N#30WThe Phantom Flame plan…\x02",
    )
    ...
    ChrTalk(
        0x104,
        (
            "#12P#00304Fま、そういうことRight.\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00000Fああ、Yeah we should\x01",
            "……どうでしょう、リースさHuh?\x02",
        )
    )
