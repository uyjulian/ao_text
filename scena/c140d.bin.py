...
def main():
    ...
    ChrTalk(
        0x101,
        "#00000FI'm glad we could be of help\x02",
    )
    ...
    ChrTalk(
        0x13,
        (
            "#04100FWell that should wrap up this request\x02\x03",
            "また何かあったら\x01",
            "旧市街の連中に力を貸してくれ。\x02",
        )
    )
