...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00003F……ああ、Yeah we should\x02\x03",
    ...
    ChrTalk(
        0x13,
        (
            "#01203F#3Cうむ、あのRed Constellationとやらにな。\x02\x03",
    ...
    ChrTalk(
        0xE,
        (
            "#00301FRed Constellationの飛行艇は退けたが、\x01",
            "奴らににとっちゃ\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "Red Constellationの方が上だろうが……\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "Red Constellationの連中は、\x01",
            "今まで通りに襲ってくるだろう。\x02\x03",
            "#00308FNo…むしろ今まで以上に\x01",
            "なりふり構わねえ手段を\x01",
    ...
    ChrTalk(
        0xE,
        (
            "#00309Fまさか工房まであるたAh...\x01",
            "いや〜、メルカバってのは\x01",
            "至れり尽くせりだねHuh\x02\x03",
    ...
    ChrTalk(
        0xA,
        (
            "#10404FYes, that's right\x02\x03",
    ...
    ChrTalk(
        0x8,
        (
            "#12100FRed Constellationとは今後も\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00001FI see…だとすると、\x01",
            "今はブースター地点での作戦に\x01",
            "集中した方がよさYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "助け出すまでは戻れない……か。\x01",
            "やっぱり厳しい戦いになりYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#12100Fヴァルドを退けたYeah we should\x02\x03",
            "……奴とは、２年前に\x01",
            "ワジと共にクロスベルに潜入して\x01",
            "以来の付き合いだが……\x02\x03",
            "カモフラージュとして\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00003FあAh...Yeah we should\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00004F……ああ、Yeah we should\x02\x03",
    ...
    ChrTalk(
        0xF,
        (
            "#02103F謎のThe Society of Oroborous\x01",
            "リベールで起こった異変でも\x01",
            "暗躍してたって話よね。\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00003F……That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00003F……That's fine, thank you\x02\x03",
    ...
    ChrTalk(
        ...
        (
            "大陸最強の猟兵団の一つである\x01",
            "Red Constellationを相手に立ち回るなんて\x01",
            "相当に厳しいはずですが……\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#12100FHmm.Yeah we should\x02\x03",
            "よければこれを受け取るがいい。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#11P#00005FThis is..もらってもいいのか？\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#00004F……That's fine, thank you\x02\x03",
