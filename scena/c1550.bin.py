...
def main():
    ...
    ChrTalk(
        ...
        (
            "#00104FいUh…\x01",
            "ですが、That's fine, thank you\x02\x03",
    ...
    ChrTalk(
        0x2D,
        (
            "#02503FYes that's right\x02\x03",
    ...
    ChrTalk(
        0x13,
        (
            "#07002FEhe, thank you so much\x02\x03",
    ...
    ChrTalk(
        0xFE,
        (
            "危険度Ｓ、Jaeger Corps, Red Constellation\x01",
            "ディーター大統領が彼らと\x01",
            "繋がっていたという疑惑はあった。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00003F#6Pええ、Thanks for your hard work\x02\x03",
    ...
    ChrTalk(
        0x2B,
        (
            "#11304F#5P……フフ、Yeah we should\x01",
    ...
    ChrTalk(
        0x102,
        "#6P#00108FどうしてIn a place like this\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#6P#10106F……ご忠告、That's fine, thank you\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "各国首脳に用意された\x01",
            "控え室のあるフロアだ。\x02\x03",
            "#02800FI will show you a bit\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00305F#5POhh, it's so extravagant!\x02",
    )
    ...
    ChrTalk(
        0x2E,
        (
            "#00603F#11PWell then I will head back to the 34F\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#6P#10300FLet's start patrolling then?\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#6P#00104FWell then excuse me\x02",
    )
    ...
    ChrTalk(
        0x2F,
        (
            "#07400F#11PHumph. This view is truly spectacular.\x02\x03",
            "地上をこの高さから\x01",
            "見下ろせるような建造物を\x01",
            "人間が作り出せるとは……\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#07401FThe true symbol of the possibilities and foolishness of humanity\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#6P#00001FHumanity's possibilities and foolishness\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#6P#00208FYou know about all that\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00006FThe Empire's Information Department\x02\x03",
    ...
    ChrTalk(
        0x2F,
        (
            "#07404F#11POh just simple talk\x02\x03",
            "#07400Fもしくは意識調査と\x01",
            "言い換えてもいいだろう。\x02",
        )
    )
    ...
    ChrTalk(
        0x2F,
        (
            "#07403F#11PYes. I will be frank\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#6P#10306FThat's quite a direct question\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00003F#30W……That's true\x01",
            "帝国や共和国に比べたら\x01",
    ...
    ChrTalk(
        0x105,
        "#6P#10304FThe 100 days war from 12 years ago\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#6P#00301FHey hey, what kind of joke is that\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#5P#00106FThat wasn't unreasonable\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#6P#00310FBut he's a real monster\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#5P#00301FYeah. It's a crime of conscience\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#5P#00108FIn that case let's patrol around again-\x02",
    )
    ...
    ChrTalk(
        0x2E,
        (
            "#00603F#5PThis is First Investigator Dudley\x02\x03",
            "#00605F……エマ君か。\x01",
            "いったいどうした──\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#5P#00108F(Something happened)\x02",
    )
    ...
    ChrTalk(
        0x2E,
        (
            "#00606F#11P──Red ConstellationとHeiyueが\x01",
            "それぞれの拠点から動いたそうだ。\x02\x03",
            "#00601FThey've escaped our watch\x02",
        )
    )
    ...
    ChrTalk(
        0x2E,
        (
            "#5P#00603F#12AOh right\x02\x03",
            "#14A#00601F予備の警官隊を\x01",
            "動かしてもいいから……\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#11PRandy, settle down\x02\x03",
            "#00001FいくらRed Constellationでも\x01",
            "ここに仕掛けるとは思えない。\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        "#00208F#11PThat's messed up\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00101F#11PIs it from Dudley\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "No time. I'll keep this brief\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#00203F#20WIt's kind of hard\x02\x03",
            "#00201FBut I can do it…\x02",
        )
    )
    ...
    ChrTalk(
        0x34,
        (
            "#10504F#5P……Yeah we should\x02\x03",
            "サヤがいればきAhh\x01",
            "困った顔で説教されただろう。\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        "#12P#N#10106FOh is that right\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#12P#00106FOh is that right\x02",
    )
    ...
    AnonymousTalk(
        0x103,
        "#00208F#30Wガイさんが使ってThere he is…\x02",
    )
    ...
    AnonymousTalk(
        0x106,
        (
            "#10703F#30WThis is..刀傷True.\x02\x03",
            "#10708Fということは……\x01",
            "ロイドさんのお兄さんを\x01",
            "手に掛けたのは……\x02",
        )
    ...
    ChrTalk(
        ...
        (
            ...
            "銃による背後からの狙撃#22R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵　噵#。\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "背後から銃で撃たれた#20R噵　噵　噵　噵　噵　噵　噵　噵　噵　噵#ことだ。\x02",
        )
    )
    ...
    ChrTalk(
        0x106,
        "#6P#10702Fまるで誂#2Rあつら#えたようAh…\x02",
    )
