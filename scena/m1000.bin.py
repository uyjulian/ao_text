...
def main():
    ...
    ChrTalk(
        ...
        (
            "#00003F#6P……とにかく、今は\x01",
            "引いたほうがよさYeah we should\x02\x03",
            "#00005Fそれにしてもワジ、\x01",
            "やっぱり《結社》については\x01",
            "随分と詳しいみたいだな？\x02",
        )
    ...
    ChrTalk(
        0x106,
        (
            "#10709F#6Pあ、あHaha…\x01",
            "アッバスさんも苦労してそうTrue.\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#6Pアッバスも苦労してYeah…\x02\x03",
    ...
    AnonymousTalk(
        ...
        (
            ...
            "《鋼の聖女》が連れていた\x01",
            "部下の１人だったかしら。\x02\x03",
            "#00101Fそれに、あのWhite doll soldiers…\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00000FOK made it to the Stargaze Tower\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00100FYeah. It's been a while\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "なかなかの高さだね。\x02\x03",
            "#10304FMust be hard to investigate the whole thing\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00304FWell, let's get moving\x02",
    )
    ...
    AnonymousTalk(
        ...
        (
            ...
            "#3896V#40A#30W我が《鉄機隊》が運用している\x01",
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "#3897V#40A#30W無事、カンパネルラの守りを\x01",
            "突破したようTrue.\x02\x03",
            "#3898V#45A#30Wこの宿業の塔では\x01",
    ...
    ChrTalk(
        0x104,
        "#00305F#12Pそいつは……確かにYeah we should\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#5P……Yeah we should\x02\x03",
