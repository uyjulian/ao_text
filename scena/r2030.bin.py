...
def main():
    ...
    ChrTalk(
        0xE,
        (
            "#04704F#6Pフフ、せいぜい頑張りたまHuh\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#6PあAh...そんな事もあったな。\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#5PあAh...そんな事もあったな。\x02\x03",
            "#00008F（結局、あれが誰の仕業か\x01",
            "  いまだ明らかになっていない。）\x02\x03",
            "#00001F（もうレンはいないけど……\x01",
            "  ちょっと様子を見に行こうか？）\x02",
    ...
    ChrTalk(
        0x1C,
        "#04612F#12P#4S#10Aアハハハハハハハハッ!!!\x02",
    )
    ...
    ChrTalk(
        0x1C,
        "#04602F#11P#4S#8Aイッッけええええええ!!\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "マインツ方面で動きが\x01",
            "あったのかもしれません。\x02\x03",
            "#10701FRed Constellationが本格的に\x01",
            "レジスタンス狩りを始めたとか。\x02",
        )
    )
