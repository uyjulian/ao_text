...
def main():
    ...
    ChrTalk(
        0x8,
        (
            "#04303F#11PYeah, that's us.\x02\x03",
    ...
    ChrTalk(
        0x10A,
        (
            "#00606F#5POh don't be pretentious.\x02\x03",
    ...
    ChrTalk(
        0x10A,
        (
            "#00610F#5PHey you shut up.\x02\x03",
    ...
    ChrTalk(
        0x109,
        "#6P#10109FGood work everyone!\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#04300F#11PSo then what are you guys gonna do?\x02\x03",
            "このまま列車で\x01",
            "クロスベルに戻るつもりか？\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#6PYep, that's the plan.\x02\x03",
            "#00005Fそうだ……\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00002F#6POh is that right\x02\x03",
            "#00004Fでも、お陰で犯人を生かしたまま\x01",
            "捕まえることができました。\x02\x03",
            "#00000FThat's fine, thank you\x01",
            "……本当に助かりました。\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        (
            "#12P#10109FYeah, I think so!\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#6PHaha, understood.\x02\x03",
    ...
    ChrTalk(
        0x109,
        "#6P#10109FThanks for your hard work!\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#6P#04302FOops, I guess it got a bit late\x02\x03",
    ...
    ChrTalk(
        0x9,
        (
            "#13804F#11PShe made an appropriate selection.\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "#13801F...But is it really that bad?\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00000FThat's fine, thank you\x02",
    )
