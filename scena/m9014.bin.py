...
def main():
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xD),
            "#12306F#3649V#11P#60W#30A……どう……して….......?\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xD),
            "#12314F#11P#40WI see….えへWhat…\x02\x03",
            "#12308F……でもKeA…\x01",
            "ロイドにそんな風にしてもらう\x01",
            "資格なんてない……\x02\x03",
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xD),
            "#12317F#3651V#12P#40W#30A……ロイ……ド…………\x02\x03",
            "#12316F#3652V#50W#35ALloyd…ロイドおおぉっ…!\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#05817F#3653V#12P#40W#70A……ぅぅUhぁぁああっ…!\x02\x03",
            "#3654V#35A#4Sわぁぁぁぁぁぁぁっ…!\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#5P#20A#30W──さあ、帰ろう。\x01",
            "みんなが俺たちを待っている。\x02\x03",
            "#00002F#20Aこのまま抱っこするから\x01",
            "ちゃんと掴まっているんだぞ？\x02",
        )
    )
