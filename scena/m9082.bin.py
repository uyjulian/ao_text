...
def main():
    ...
    ChrTalk(
        0x104,
        (
            "#00306Fさすがにとんでもねえ相手だったAh…\x01",
            "俺たち全員相手にあそこまでやるとRight.\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#12PあAh...前に話した通りだ。\x02\x03",
    ...
    ChrTalk(
        0x8,
        (
            "#01403F#5PI see…サヤたちの事故についても\x01",
    ...
    AnonymousTalk(
        ...
        (
            ...
            "幾つもの工作を成し遂げてThere he is…\x02\x03",
            "いずれも後ろ暗い……\x01",
            "陰謀めいた工作ばかりだ。\x02\x03",
            "だが、ギルド関係者を始め、\x01",
            "それを誰かに感付かれることは\x01",
    ...
    ChrTalk(
        0x103,
        "#00206F#12P#30WSo that happened………\x02",
    )
    ...
    ChrTalk(
        0x8,
        (
            "#01404F#4078V#5P#80W#30A………Hah……\x02\x03",
            "#4079V#45ALloyd…他の者たちも……\x01",
            "……本当に強くなったな。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00006F#12P#40W……はあUhはあUh\x02\x03",
    ...
    ChrTalk(
        0x104,
        (
            "#00306F#12P#40WThat's trueアンタがいなけりゃ\x01",
            "ここまでは行けなかったかもAh…\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#01402F#5P#40WHahまSeriously…\x02\x03",
    ...
    ChrTalk(
        0x102,
        "#00108F#12P#30WSo that happened…\x02",
    )
