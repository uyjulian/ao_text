...
def main():
    ...
    ChrTalk(
        0x101,
        "#5P#00000FYep. Let's do that\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "何かしらの対策を考えてくれYeah we should\x02",
        )
    )
