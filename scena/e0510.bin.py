...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#00003F課長もあれで結構忙しい人だしAh…\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00004F#12PYeah. To feel the breeze\x02\x03",
            "#00005FUh, am I bothering you?\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "お互いの隙を狙って併合して\x01",
            "果実を独り占めをする……\x02\x03",
            "#00106FThat must have been planned\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#00103F#11PYeah I know.私もベルには\x01",
            "聞きたいことが結構あるし……\x02",
        )
    )
    ...
    ChrTalk(
        0x9,
        "#10108F#5P#30WAfter something like that happened…\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000F#12PBecause something like that happened.\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00005F#12POf coruse they are\x02\x03",
            "#00000Fみんなで休暇が取れるなんて\x01",
            "滅多にあることじゃないからな。\x02\x03",
            "#00012FHaha, I feel bad for the director though\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "少しでも元気付けようと─#500W─#30W#00011Fあ。\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#00104F#5PEhe, don't pout at me\x02\x03",
            "#00102F……ごめんなさい。\x01",
            "私たちの方こそちょっと\x01",
            "空気が読めていなかったわ。\x02",
        )
    ...
    ChrTalk(
        0x101,
        (
            "#00002F#6P……Yeah we should\x02\x03",
            "#00008F….\x02",
        )
    )
