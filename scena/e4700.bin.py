...
def main():
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00006Fい、No…そういうわけでRight.\x02\x03",
    ...
    ChrTalk(
        ...
        (
            ...
            "Red Constellationと言えども容易には\x01",
    ...
    ChrTalk(
        ...
        (
            ...
            "#03200F国防軍やRed Constellationを\x01",
            "正面から相手にするのも\x01",
    ...
    AnonymousTalk(
        ...
        (
            ...
            "#14Iバーストオーブ\x07\x05",
            "Got FORCE from Dudley\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x9,
        (
            "#5P#03204F流石は特務支援課の皆さんTrue.\x02\x03",
            "まさか、マクダエル議長と共に\x01",
            "『クロスベル独立国』の\x01",
