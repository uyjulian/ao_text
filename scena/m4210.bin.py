...
def main():
    ...
    ChrTalk(
        0x102,
        "#00108F#12Pこ、工房で聞There he is…!?\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00206F#12Pランディさん、そういう問題でRight.\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#11P……話はUnderstood.\x02\x03",
            "#00001F俺たちはこのまま\x01",
            "リンさんの安全を確認します。\x02",
        )
    )
