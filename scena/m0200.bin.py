...
def main():
    ...
    ChrTalk(
        0x13E,
        (
            "#11P#02305Fお、戻ってきたみたいRight.\x02\x03",
            "#02302Fそれじゃ、さっさと\x01",
            "第４制御端末に向かおうぜ!\x02",
        )
    )
    ...
    ChrTalk(
        0x12,
        "#6P#03209FWell then we'll pull out here\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#11P#00011FThis is..また凄い場所Right.\x02",
    )
    ...
    ChrTalk(
        0x102,
        (
            "#11P#00106FYeah I know.このエリアも\x01",
            "ちゃんと活かされているとは\x01",
            "言いがたいみたいだし。\x02",
        )
    )
