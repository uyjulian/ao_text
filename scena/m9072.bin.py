...
def main():
    ...
    ChrTalk(
        0x10A,
        "#00601F#13PRed Constellationの副団長か……\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#10101F#13PRed Constellationの副団長……\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00101F#12PRed Constellationの副団長……\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "足りない部分は兄貴の代わりに\x01",
            "俺が仕込んでやる。\x02\x03",
            "#04504Fそして名実共にRed Constellationの\x01",
            "団長となった暁には……\x02\x03",
    ...
    ChrTalk(
        0x104,
        (
            "#00304F#12P#30Wクク、I see…\x02\x03",
            "#00312F冷徹かつ合理的に、\x01",
            "猛き衝動を飼い慣らす……\x02\x03",
    ...
    ChrTalk(
        0x8,
        (
            "#04502F#5P#30WHah…\x02\x03",
            "#04504F…………ハハHaha……\x02\x03",
            "#04501F──御託はそれだけか？\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        "#00303F#2771V#12P#30W#20AあAhh!望むところだ。\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "持てる力の全てを掛けて……\x02\x03",
            "#00307F#2773V#35A最強の猟兵であるアンタを\x01",
            "ブチのめさせてもらう!\x02",
        )
    )
    ...
    ChrTalk(
        0x8,
        (
            "#04504F#3850V#5P#30W#35AHaha面白い。\x02\x03",
    ...
    AnonymousTalk(
        ...
        (
            ...
            "#3849V#30W#52A戦場を喰らい、蹂躙し尽くす、\x01",
    ...
    ChrTalk(
        0x8,
        (
            "#04510F#5P#40WHaha今さらなんだ.......?\x02\x03",
    ...
    ChrTalk(
        0x104,
        (
            "#00306F#11P#30WあAh...分かってたさ。\x02\x03",
            "#00303F荒っぽいのはウチの一族の\x01",
            "流儀みたいなモンだからAh…\x02\x03",
            "#00300F……だが……\x01",
            "これで何とかけじめは付けた。\x02",
        )
    )
