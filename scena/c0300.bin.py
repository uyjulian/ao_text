...
def main():
    ...
    ChrTalk(
        0xFE,
        "ディーター大統領が拘束されたYeah we should\x02",
    )
    ...
    ChrTalk(
        ...
        (
            "ふむ、チケットは急ぎ\x01",
            "確保しておいたほうがよさYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        0xF,
        (
            "#03600FHaha…That's fine, thank you\x01",
            "みなさんもどうかお気をつけて。\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        "#00105FどうしてIn a place like this\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00003FLooks like it's empty huh\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#5P#00003FあAh...だが、今のところは\x01",
            "放っておくしかなさYeah we should\x02\x03",
            "#00000F……とにかく、\x01",
            "これで住宅街の調査は終了だ。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#5P#00003FRight. I'm worried about it to.\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#5P#00000Fよし、これで一通り調査は済んRight.\x02\x03",
            "市民会館へ報告に戻ろう。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00000FOh it was this one\x02\x03",
            "#00006F……って、君の同行を\x01",
            "認めたわけじゃないんだけどな。\x02",
        )
    )
    ...
    ChrTalk(
        0x1A3,
        "#12P#04609FWell then let's get going\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#6P#00303FDon't lump me in with her\x02",
    )
    ...
    ChrTalk(
        0x1A3,
        "#5P#04602FBut we know where she's going now we just have to catch her\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#12P#00000FYeah we should be able to quickly\x02",
    )
