...
def main():
    ...
    ChrTalk(
        0x101,
        "#00000FNice to see you again\x02",
    )
    ...
    ChrTalk(
        ...
        (
            "ふむ、さすがに性能は低いけど\x01",
            "いざというときは代用がききYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "弱音を吐いてはいられん。\x01",
            "なんとか工夫するしかなさYeah we should\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "憎たらしいやつだなお前Right!\x02\x03",
            "#00309F『がんばってね、ロイド噴』\x01",
            "……だってよ、だってよ!\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            "#01400F閣下の護衛のことは\x01",
            "よろしくWe're counting on you SSS\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        "#10100FThanks for your hard work!\x02",
    )
    ...
    ChrTalk(
        0x102,
        "#00100FEhe, thank you so much\x02",
    )
