...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#00301FあんたがRed Constellationの\x01",
            "御用商人か資金調達係なのは\x01",
            "分かってるからな。\x02\x03",
            "連中がクロスベルであんなことを\x01",
            "やらかしちまったから、\x01",
