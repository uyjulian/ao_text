...
def main():
    ...
    ChrTalk(
        0x101,
        "#00001F#6P#N（In a place like this）\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00000F#6PCome on逆だよキーア。\x02\x03",
