...
def main():
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('月之宝珠', 0x0)"), scpexpr(EXPR_END)), "loc_EB6")
    EventBegin(0x1)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('月之宝珠', 0x0)"), scpexpr(EXPR_END)), "loc_109D")
    EventBegin(0x1)
