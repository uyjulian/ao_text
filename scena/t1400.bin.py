...
def main():
    ...
    ChrTalk(
        0x16,
        "では、チケットをOk we'll hold on to this\x02",
    )
    ...
    ChrTalk(
        0x104,
        (
            "#00309Fはは、Yeah we should\x02\x03",
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0xA),
            "#05205Fな、なるほどThat's true\x02\x03",
            "#05203F（緩衝材でも入れてるんRight.\x01",
