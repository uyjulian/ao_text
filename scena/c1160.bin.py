...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "いつでもご相談ください。\x02\x03",
            "#00004F……Well then excuse me\x02",
        )
    )
