...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "  ミスコンに出場できYeah we should）\x02\x03",
            "#00000Fあの、すみません。\x01",
            "ちょっと相談なのですが……\x02",
        )
    )
