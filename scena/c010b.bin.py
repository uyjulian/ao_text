...
def main():
    ...
    ChrTalk(
        ...
        (
            ...
            "#10301FEveryone is gonna get mad though, right?\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        (
            "#6P#00306FThat's right\x02\x03",
            "#00301FBut they're my problem\x02\x03",
            "Uncle and Shirley\x02\x03",
            "ましてやロイドたちを\x01",
            "巻き込んでいいわけがねぇ。\x02\x03",
            "#00303F俺は……俺自身のケリを\x01",
            "付けるためにここを出て行く。\x02\x03",
            "#00300FBut that's it\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#10308F#5PHmm. Well that's fine then\x02\x03",
    ...
    ChrTalk(
        0x104,
        (
            "#6P#00306FLeave me alone\x02\x03",
            "#00305F……しかしお前……\x01",
            "前から聞きたいと思ってたんだが。\x02\x03",
            "#00302F本当のところ、どっち#6R噵　噵　噵#なんだ？\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#10304F#5PEhe, I gues so\x02\x03",
            "#10302F──黙ってくれていたお礼に\x01",
            "明日の朝、しらばっくれてあげるよ。\x02\x03",
            "Rage as hard as you like\x02",
        )
    )
