...
def main():
    ...
    ChrTalk(
        ...
        (
            "#00002FI see..\x01",
            "ご理解That's fine, thank you\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00000F#6P各国の軍隊・警察組織True.\x02\x03",
    ...
    ChrTalk(
        0x105,
        (
            "#10304FI see. So that' what you mean\x02\x03",
            "#10300Fその調査結果をもとに、\x01",
            "本の回収計画を進めるわけだね。\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x0),
            "#10100F司令、Thanks for your hard work\x01",
            "ノエル・シーカーです。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004FYeah, let's do that\x02\x03",
            "#00002Fマイルズおじさん、\x01",
            "楽しみに待っててよ。\x02",
        )
    )
