...
def main():
    ...
    ChrTalk(
        0x13,
        (
            "#07902FRight, thanks a lot!\x02\x03",
    ...
    ChrTalk(
        0x13,
        (
            "#07904F……That's fine, thank you\x01",
            "このご恩は決して忘れません。\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        "#00002F#6P皆さん、Nice to see you again\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#6P#00000FThat's fine, thank you\x01",
            "大切に使わせていただきます。\x02",
        )
    )
