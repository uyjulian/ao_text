...
def main():
    ...
    ChrTalk(
        0x102,
        "#12P#00108FBut that's not all of your responsibility…\x02",
    )
    ...
    ChrTalk(
        0xA,
        "#5PIt's true that we weren't involved in the case,\x02",
    )
    ...
    ChrTalk(
        0xA,
        "#5PHonestly we have plenty of social responsibility in the matter\x02",
    )
    ...
    ChrTalk(
        0xB,
        "#5PAfter we heard about that from them\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#12P#00005Fなるほど、Oh is that right\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#12P#00002FOH thank you very much\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#12P#00306Fったく、とんでもねえ兄さんだAh…\x02",
    )
    ...
    ChrTalk(
        0x104,
        "#12P#00301FWho was taken with what now?\x02",
    )
    ...
    ChrTalk(
        0x109,
        "#12P#10101FWe will have you come with us this time\x02",
    )
    ...
    ChrTalk(
        0x109,
        (
            "#12P#10108Fうーん、But..\x01",
            "ミュラーさんの方からこちらに\x01",
            "来てもらうのがよさそうTrue.\x02\x03",
            "#10106FI'm not sure we can keep track of him as we walk\x02",
        )
    )
    ...
    ChrTalk(
        0x10,
        "#5P#13910FUgh, you guys don't trust me\x02",
    )
    ...
    ChrTalk(
        0x104,
        (
            "#12P#00306FThat's right\x02\x03",
