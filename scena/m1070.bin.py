...
def main():
    ...
    Sepith("Sepith_E7D", 9,   9,   9,   21,  4,   4,   4)
    Sepith("Sepith_E75", 6,   6,   0,   0,   13,  13,  13)
    Sepith("Sepith_E6D", 8,   8,   21,  13,  0,   0,   0)
    Sepith("Sepith_E55", 19,  0,   0,   10,  10,  8,   8)
    ...
    BattleInfo(
        "BattleInfo_3D0", 0x0000, 90, 6, 60, 6, 1, 30, 0, "bm1020", "Sepith_E7D", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_560", 0x0000, 90, 6, 60, 8, 1, 25, 0, "bm1040", "Sepith_E75", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_498", 0x0000, 90, 6, 60, 8, 1, 25, 0, "bm1040", "Sepith_E6D", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_308", 0x0000, 90, 6, 60, 6, 1, 25, 0, "bm1020", "Sepith_E55", 40, 30, 20, 10,
        (
    ...
    DeclNpc(25500,   4294952696, 0,       0,    484,  0x0, 0,   16,  0,   0,   0,   255, 255, 255,  0)

    DeclMonster(4294946956, 5580,    4294947916, 0x1010000,    "BattleInfo_3D0", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(4294959126, 23150,   4294950036, 0x1010000,    "BattleInfo_560", 0,   22,  0xFFFF, 6,  7)
    DeclMonster(7250,    23220,   4294950036, 0x1010000,    "BattleInfo_498", 0,   20,  0xFFFF, 4,  5)
    DeclMonster(17630,   4294967236, 4294952166, 0x1010000,    "BattleInfo_308", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(4294958946, 4294941696, 4294950046, 0x1010000,    "BattleInfo_498", 0,   20,  0xFFFF, 4,  5)
    DeclMonster(4294940906, 4294959816, 4294947916, 0x1010000,    "BattleInfo_3D0", 0,   18,  0xFFFF, 2,  3)

    DeclActor(25500,   4294952196, 0,       1200,    25500,   4294953196, 0,       0x007C, 0,  3,  0x0000)
    DeclActor(30030,   4294952296, 5370,    1200,    30030,   4294953296, 5370,    0x007C, 0,  4,  0x0000)
    ...
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x218, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_BC2")
    ...
    OP_F4(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1F7, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_DD7")
    Sound(14, 0, 100, 0)
    OP_74(0x1, 0x1E)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x41A, 1)"), scpexpr(EXPR_END)), "loc_D60")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
