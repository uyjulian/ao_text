...
def main():
    ...
    ChrTalk(
        0x103,
        "#00201F#6P#NDeciple of Oroborous?\x02",
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#04922F#3902V#40A御子殿の意には極力沿うよう、\x01",
            "《盟主》に申し付かっています。\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            ...
            "#12302F#3633V#35Aあなたたちのマスターにも\x01",
    ...
    AnonymousTalk(
        0x8,
        (
            "#3903V#3C#30W#40A蛇の使徒が七柱、\x01",
            "《鋼》のアリアンロード……\x02\x03",
            "#3904V#48A《零》の御子殿の望みに従い、\x01",
    ...
    ChrTalk(
        0x101,
        (
            "#00002F#5PあAh...Yeah we should\x02\x03",
