...
def main():
    ...
    DeclMonster(26380,   45370,   4294965796, 0x101000A,    "BattleInfo_37C", 0,   16,  0xFFFF, 0,  1)
    ...
    DeclMonster(26280,   11680,   4294965796, 0x101001A,    "BattleInfo_37C", 0,   16,  0xFFFF, 0,  1)
    ...
    DeclActor(4294966746, 0,       24010,   1200,    4294966746, 1000,    24010,   0x007C, 0,  4,  0x0000)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1EF, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_CFD")
    Sound(14, 0, 100, 0)
    OP_74(0x1, 0x1E)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x42E, 1)"), scpexpr(EXPR_END)), "loc_C86")
