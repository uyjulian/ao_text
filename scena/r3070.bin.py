...
def main():
    ...
    ChrTalk(
        0xD,
        "#6PBut I don't see Randolph\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00007F#5PSounds good to me!\x02",
    )
    ...
    ChrTalk(
        0x105,
        "#10407F#6PWe're going all out!\x02",
    )
    ...
    ChrTalk(
        0x103,
        "#00208F#11PYou know about Zeit…\x02",
    )
    ...
    ChrTalk(
        0xC,
        "#11PI thought you ran away from here…\x02",
    )
    ...
    ChrTalk(
        0x13,
        (
            "#03204F#11PAhah, that's true\x02\x03",
