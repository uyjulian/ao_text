...
def main():
    ...
    AnonymousTalk(
        ...
        (
            ...
            "#3720V#30W#25Aウフフ、その通りさ。\x07\x00\x02",
        )
    )
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x2),
            "#3721V#30W#25AAhah, splendid\x02\x03",
            "#3722V#30W#32Aそれじゃあ遠慮なく\x01",
            "中に入っておいでよ。\x02\x03",
            "#3723V#30W#27A鐘の前で待ってるからさ噴\x07\x00\x02",
        )
    )
