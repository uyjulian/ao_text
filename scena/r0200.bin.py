...
def main():
    ...
    ChrTalk(
        0x104,
        (
            "#00303F#9P（報告通り、結構デケェAh…）\x02\x03",
    ...
    ChrTalk(
        0x101,
        (
            "#00003F#11P……Yeah we should\x02\x03",
    ...
    ChrTalk(
        0x101,
        "#00005F#11PThis is..新しい釣竿ですか？\x02",
    )
    ...
    ChrTalk(
        0x101,
        (
            "#00004FThat's trueこうして組みあがると\x01",
            "物凄く綺麗でカッコイイTrue.\x02",
        )
    )
