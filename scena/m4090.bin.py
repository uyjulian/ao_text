...
def main():
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x2),
            "#60W#20AAhhh… uggghh\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        0x109,
        "#10105FFrom the curch scripture…\x02",
    )
    ...
    ChrTalk(
        0x101,
        "#00005F#30W#N#6P#12AThis is…\x02",
    )
    ...
    ChrTalk(
        0xC,
        "#04306F#30W#5PPhew… Did it. Somehow.\x02",
    )
