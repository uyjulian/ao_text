...
def main():
    ...
    AnonymousTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x2),
            "#5P#N#5S#20Aハーッハッハッハッハッ！\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x5),
            "#5P#04303F#50W#25A『我が深淵にて煌く蒼の刻印よ』\x02",
        )
    )
